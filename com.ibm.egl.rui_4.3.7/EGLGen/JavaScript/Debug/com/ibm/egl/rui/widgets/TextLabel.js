...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TextLabel', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,44,1433,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,46,1524,42, this);
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,49,1612,14, this);
			this.text = textIn;
			egl.atLine(this.eze$$fileName,50,1630,17, this);
			this.setInnerText(this.text);
			egl.atLine(this.eze$$fileName,48,1574,79, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,54,1698,14, this);
			$result = this.text;
	...
	"getWidgetOrientation": function() {
		...
		try { egl.enter("getWidgetOrientation",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,58,1789,36, this);
	...
	"setWidgetOrientation": function( widgetOrientation ) {
		...
		try { egl.enter("setWidgetOrientation",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,62,1915,47, this);
			this.widgetOrientationThis = widgetOrientation;
			egl.atLine(this.eze$$fileName,63,1967,214, this);
			if ( (widgetOrientation == "RTL") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,64,2002,34, this);
					this.setStyle("text-align: right;");
					var ezert$$1 = "";
					ezert$$1 = this.getTextLayout();
					egl.atLine(this.eze$$fileName,65,2041,82, this);
					if ( (ezert$$1 != "Visual") ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,66,2083,32, this);
				...
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,69,2139,33, this);
					this.setStyle("text-align: left;");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,61,1839,348, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

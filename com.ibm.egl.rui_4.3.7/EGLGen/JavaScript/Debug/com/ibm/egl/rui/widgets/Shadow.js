...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Shadow', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/Shadow.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,344,86, this);
			...
			egl.atLine(this.eze$$fileName,13,407,20, this);
			egl.checkNull(this.div, "div").setClass("eze$$tempDiv");
	...
	"setDiv": function( div ) {
		...
		try { egl.enter("setDiv",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("div", div, "com.ibm.egl.rui.widgets.Div", "div");
			egl.atLine(this.eze$$fileName,16,467,80, this);
			if ( (egl.checkNull(this.div, "div").getClass() == "eze$$tempDiv") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,17,508,32, this);
					egl.com.ibm.egl.rui.widgets.UtilLib['$inst'].destroyWidget(this.div );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,19,551,32, this);
			this.setClass("EglRuiShadowDiv1");
			egl.atLine(this.eze$$fileName,20,587,178, this);
			this.appendChild((function () {
				var ezert$$1 = new egl.com.ibm.egl.rui.widgets.Div();
				egl.atLine(this.eze$$fileName,21,614,26, this);
				egl.checkNull(ezert$$1, "ezert$$1").setClass("EglRuiShadowDiv2");
				egl.atLine(this.eze$$fileName,21,642,115, this);
				egl.checkNull(ezert$$1, "ezert$$1").setChildren( [ (function () {
					var ezert$$2 = new egl.com.ibm.egl.rui.widgets.Div();
					egl.atLine(this.eze$$fileName,22,671,26, this);
					egl.checkNull(ezert$$2, "ezert$$2").setClass("EglRuiShadowDiv3");
					egl.atLine(this.eze$$fileName,22,699,40, this);
					egl.checkNull(ezert$$2, "ezert$$2").setChildren( [ div ] );
					return ezert$$2;
				}).call(this) ] );
				return ezert$$1;
			}).call(this) );
			egl.atLine(this.eze$$fileName,27,769,44, this);
			egl.checkNull(div, "div").setClass((egl.checkNull(div, "div").getClass() + " EglRuiShadowDiv4"));
			egl.atLine(this.eze$$fileName,28,817,15, this);
			this.div = div;
			egl.atLine(this.eze$$fileName,15,436,402, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getDiv": function() {
		...
		try { egl.enter("getDiv",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,32,877,14, this);
			$result = this.div;
			egl.setLocalFunctionVariable("Div", $result, "com.ibm.egl.rui.widgets.Div");
	...
	"eze$$getChildVariables": function() {
		...
		{name: "div", value : function(){try{return eze$$parent.getDiv();}catch(e){return null;}}(), type : "com.ibm.egl.rui.widgets.Div", jsName : "div", getter : "getDiv", setter : "setDiv"}
		];
	}
}
, 'div'

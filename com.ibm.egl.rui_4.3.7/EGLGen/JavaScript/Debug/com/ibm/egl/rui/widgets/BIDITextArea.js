...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'BIDITextArea', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/BIDITextArea.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,19,595,36, this);
			this.savedBackgroundColor = "";
			egl.atLine(this.eze$$fileName,21,637,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,22,725,94, this);
			this.readOnly = false;
			egl.atLine(this.eze$$fileName,23,822,91, this);
			this.numRows = 0;
			egl.atLine(this.eze$$fileName,24,916,100, this);
			this.numColumns = 0;
			egl.atLine(this.eze$$fileName,26,1021,47, this);
			this.reverseTextDirectionThis = "";
			egl.atLine(this.eze$$fileName,27,1071,42, this);
			this.textLayoutThis = "";
			egl.atLine(this.eze$$fileName,28,1116,42, this);
			this.widgetOrientationThis = "";
			egl.atLine(this.eze$$fileName,29,1161,39, this);
			this.handlers = null;
			
			egl.atLine(this.eze$$fileName,31,1209,25, this);
			...
			egl.atLine(this.eze$$fileName,32,1237,30, this);
			this.redraw = false;
			egl.atLine(this.eze$$fileName,33,1270,37, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,36,1333,34, this);
			...
			egl.atLine(this.eze$$fileName,37,1371,33, this);
			...
			egl.atLine(this.eze$$fileName,35,1313,97, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enableSelection": function( e ) {
		...
		try { egl.enter("enableSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,41,1479,32, this);
			var ezert$$2 = false;
			ezert$$2 = egl.egl.ui.rui.RUILib['$inst'].getTextSelectionEnabled();
			egl.atLine(this.eze$$fileName,41,1456,56, this);
			this.savedEnableSelection = ezert$$2;
			egl.atLine(this.eze$$fileName,42,1516,37, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(true );
			egl.atLine(this.eze$$fileName,40,1416,143, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"disableSelection": function( e ) {
		...
		try { egl.enter("disableSelection",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,46,1606,53, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(this.savedEnableSelection );
			egl.atLine(this.eze$$fileName,45,1565,100, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"append": function( text ) {
		...
		try { egl.enter("append",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,50,1706,88, this);
			if ( this.redraw ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,51,1729,9, this);
					var ezert$$3 = "";
					ezert$$3 = this.getText();
					egl.atLine(this.eze$$fileName,51,1721,26, this);
					this.setText((ezert$$3 + text) );
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,53,1760,27, this);
					this.buffer.appendElement( text );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,49,1671,129, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setRedraw": function( draw ) {
		...
		try { egl.enter("setRedraw",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,58,1845,14, this);
			this.redraw = draw;
			var bufSize = 0;
			egl.addLocalFunctionVariable("bufSize", bufSize, "int", "bufSize");
			egl.atLine(this.eze$$fileName,59,1877,16, this);
			var ezert$$4 = 0;
			ezert$$4 = this.buffer.getSize();
			egl.atLine(this.eze$$fileName,59,1863,31, this);
			bufSize = ezert$$4;
			egl.setLocalFunctionVariable("bufSize", bufSize, "int");
			egl.atLine(this.eze$$fileName,60,1898,158, this);
			if ( (this.redraw && (bufSize > 0)) ) {
				try{egl.enterBlock();
					var s = "";
					egl.addLocalFunctionVariable("s", s, "string", "s");
					egl.atLine(this.eze$$fileName,62,1942,64, this);
					{
						try{egl.enterBlock();
							var i = 0;
							...
							for ( ; (i <= bufSize); i = (i + 1) )
							{
								egl.setLocalFunctionVariable("i", i, "int");
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,63,1976,22, this);
					...
					egl.atLine(this.eze$$fileName,65,2011,10, this);
					this.append(s );
					egl.atLine(this.eze$$fileName,66,2026,23, this);
			...
			egl.atLine(this.eze$$fileName,57,1806,256, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getNumRows": function() {
		...
		try { egl.enter("getNumRows",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,71,2105,38, this);
			this.numRows = egl.convertAnyToInt(ezert$$6,false);
			egl.atLine(this.eze$$fileName,72,2147,17, this);
			$result = this.numRows;
	...
	"setNumRows": function( rows ) {
		...
		try { egl.enter("setNumRows",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,76,2212,15, this);
			this.numRows = rows;
			egl.atLine(this.eze$$fileName,77,2231,27, this);
			this.setAttribute("rows", {eze$$value : rows, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,75,2176,88, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getNumColumns": function() {
		...
		try { egl.enter("getNumColumns",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,81,2311,41, this);
			this.numColumns = egl.convertAnyToInt(ezert$$7,false);
			egl.atLine(this.eze$$fileName,82,2356,19, this);
	...
	"setNumColumns": function( cols ) {
		...
		try { egl.enter("setNumColumns",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,86,2426,18, this);
			this.numColumns = cols;
			egl.atLine(this.eze$$fileName,87,2448,27, this);
			this.setAttribute("cols", {eze$$value : cols, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,85,2387,94, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( txt ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,91,2530,11, this);
			this.text = txt;
			egl.atLine(this.eze$$fileName,92,2545,27, this);
			this.setAttribute("value", {eze$$value : txt, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,93,2576,14, this);
			this.reverseText();
			egl.atLine(this.eze$$fileName,90,2487,112, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,97,2652,14, this);
			this.reverseText();
			var ezert$$8 = null;
			ezert$$8 = this.getAttribute("value" );
			egl.atLine(this.eze$$fileName,98,2672,29, this);
			this.text = egl.convertAnyToString(ezert$$8,false);
			egl.atLine(this.eze$$fileName,99,2705,14, this);
			$result = this.text;
	...
	"getReadOnly": function() {
		...
		try { egl.enter("getReadOnly",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,103,2782,17, this);
	...
	"setReadOnly": function( ro ) {
		...
		try { egl.enter("setReadOnly",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,107,2857,14, this);
			this.readOnly = ro;
			egl.atLine(this.eze$$fileName,108,2875,285, this);
			if ( ro ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,109,2886,33, this);
					this.setAttribute("readOnly", {eze$$value : "true", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,110,2924,39, this);
					this.savedBackgroundColor = this.getBackgroundColor();
					egl.atLine(this.eze$$fileName,111,2968,23, this);
					this.setBackgroundColor(String('',null));
					egl.atLine(this.eze$$fileName,112,2996,37, this);
					this.setClass("EglRuiBIDITextAreaReadOnly");
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,114,3046,29, this);
					this.setAttribute("readOnly", {eze$$value : "", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,115,3080,39, this);
					this.setBackgroundColor(this.savedBackgroundColor);
					egl.atLine(this.eze$$fileName,116,3124,29, this);
					this.setClass("EglRuiBIDITextArea");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,106,2810,356, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,121,3254,53, this);
			this.reverseTextDirectionThis = reverseTextDirection;
			egl.atLine(this.eze$$fileName,122,3311,14, this);
			this.reverseText();
			egl.atLine(this.eze$$fileName,120,3171,162, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,126,3408,39, this);
	...
	"getWidgetOrientation": function() {
		...
		try { egl.enter("getWidgetOrientation",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,130,3525,36, this);
	...
	"setWidgetOrientation": function( widgetOrientation ) {
		...
		try { egl.enter("setWidgetOrientation",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,134,3649,47, this);
			this.widgetOrientationThis = widgetOrientation;
			egl.atLine(this.eze$$fileName,135,3700,16, this);
			this.setBidiStyles();
			egl.atLine(this.eze$$fileName,133,3573,151, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setTextLayout": function( textLayout ) {
		...
		try { egl.enter("setTextLayout",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,139,3794,33, this);
			this.textLayoutThis = textLayout;
			egl.atLine(this.eze$$fileName,140,3831,16, this);
			this.setBidiStyles();
			egl.atLine(this.eze$$fileName,142,3856,64, this);
			if ( (this.handlers == null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,143,3881,32, this);
			...
			egl.atLine(this.eze$$fileName,145,3924,30, this);
			this.handlers.AttachHandlers( this );
			egl.atLine(this.eze$$fileName,146,3958,14, this);
			this.reverseText();
			egl.atLine(this.eze$$fileName,138,3732,249, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTextLayout": function() {
		...
		try { egl.enter("getTextLayout",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,150,4047,29, this);
	...
	"setBidiStyles": function() {
		...
		try { egl.enter("setBidiStyles",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,154,4116,51, this);
			...
			egl.atLine(this.eze$$fileName,155,4171,69, this);
			...
			egl.atLine(this.eze$$fileName,156,4246,52, this);
			this.setBiDiStyles(isVisual, isWidgetOrientationRTL );
			egl.atLine(this.eze$$fileName,153,4088,218, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"reverseText": function() {
		...
		try { egl.enter("reverseText",this,arguments,eze$$updater);
			var isVisual = false;
			egl.addLocalFunctionVariable("isVisual", isVisual, "boolean", "isVisual");
			egl.atLine(this.eze$$fileName,160,4338,51, this);
			isVisual = (this.textLayoutThis == "Visual");
			egl.setLocalFunctionVariable("isVisual", isVisual, "boolean");
			...
			egl.atLine(this.eze$$fileName,161,4393,68, this);
			...
			egl.atLine(this.eze$$fileName,162,4470,146, this);
			if ( (isVisual && isReverseDirection) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,163,4509,66, this);
					if ( (this.handlers == null) ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,164,4535,32, this);
							this.handlers = (function () {
					...
					egl.atLine(this.eze$$fileName,166,4582,27, this);
					this.handlers.ReverseText( this );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,159,4312,310, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

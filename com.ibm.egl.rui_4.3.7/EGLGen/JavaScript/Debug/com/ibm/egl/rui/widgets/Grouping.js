...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Grouping', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/Grouping.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,391,70, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,14,464,97, this);
			this.legend = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "legend");
			
			egl.atLine(this.eze$$fileName,15,564,17, this);
			this.contents = new egl.com.ibm.egl.rui.widgets.Div();
			egl.addEmbeddedWidget(this, "contents");
			
			egl.atLine(this.eze$$fileName,16,584,78, this);
			this.fieldset = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "fieldset");
			
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,11,324,23, this);
			this.targetWidget = this.fieldset;
			egl.atLine(this.eze$$fileName,14,480,18, this);
			this.legend.setTagName( "legend" );
			egl.atLine(this.eze$$fileName,16,610,20, this);
			this.fieldset.setTagName( "fieldset" );
			egl.atLine(this.eze$$fileName,16,632,27, this);
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,19,703,24, this);
			this.legend.setInnerHTML( text );
			egl.atLine(this.eze$$fileName,18,667,66, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,23,778,26, this);
	...
	"removeChildren": function() {
		...
		try { egl.enter("removeChildren",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,27,859,26, this);
			egl.checkNull(this.contents, "contents").removeChildren();
			egl.atLine(this.eze$$fileName,26,817,74, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setChildren": function( children ) {
		...
		try { egl.enter("setChildren",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,31,956,31, this);
			egl.checkNull(this.contents, "contents").setChildren(children );
			egl.atLine(this.eze$$fileName,30,897,96, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getChildren": function() {
		...
		try { egl.enter("getChildren",this,arguments,eze$$updater);
			var $result = null;
			var ezert$$1 = null;
			ezert$$1 = egl.checkNull(this.contents, "contents").getChildren();
			egl.atLine(this.eze$$fileName,35,1056,32, this);
			$result = ezert$$1;
	...
	"appendChild": function( newChild ) {
		...
		try { egl.enter("appendChild",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,39,1157,31, this);
			egl.checkNull(this.contents, "contents").appendChild(newChild );
			egl.atLine(this.eze$$fileName,38,1100,94, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setLegend": function( widget ) {
		...
		try { egl.enter("setLegend",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("widget", widget, "egl.ui.rui.Widget", "widget");
			egl.atLine(this.eze$$fileName,43,1240,16, this);
			this.legend = widget;
			egl.atLine(this.eze$$fileName,44,1260,38, this);
			this.fieldset.setChildren( [ this.legend, this.contents ] );
			egl.atLine(this.eze$$fileName,42,1200,104, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getLegend": function() {
		...
		try { egl.enter("getLegend",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,48,1351,16, this);
			$result = this.legend;
			egl.setLocalFunctionVariable("Widget", $result, "egl.ui.rui.Widget");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"eze$$getChildVariables": function() {
		...
		{name: "legend", value : function(){try{return eze$$parent.getLegend();}catch(e){return null;}}(), type : "egl.ui.rui.Widget", jsName : "legend", getter : "getLegend", setter : "setLegend"},
		{name: "contents", value : eze$$parent.contents, type : "com.ibm.egl.rui.widgets.Div", jsName : "contents"},
		{name: "fieldset", value : eze$$parent.fieldset, type : "egl.ui.rui.Widget", jsName : "fieldset"}
		];
	}
}
);

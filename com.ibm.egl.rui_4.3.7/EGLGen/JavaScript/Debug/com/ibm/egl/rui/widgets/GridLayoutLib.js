...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.widgets.GridLayoutLib');
else egl.eze$$userLibs = ['com.ibm.egl.rui.widgets.GridLayoutLib'];
egl.defineRUILibrary( 'com.ibm.egl.rui.widgets', 'GridLayoutLib',
	{
		'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/GridLayoutLib.egl',
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,14,357,25, this);
				this.ALIGN_LEFT = 0;
				egl.atLine(this.eze$$fileName,15,386,27, this);
				this.ALIGN_CENTER = 1;
				egl.atLine(this.eze$$fileName,16,416,26, this);
				this.ALIGN_RIGHT = 2;
				egl.atLine(this.eze$$fileName,18,447,25, this);
				this.VALIGN_TOP = 3;
				egl.atLine(this.eze$$fileName,19,476,28, this);
				this.VALIGN_MIDDLE = 4;
				egl.atLine(this.eze$$fileName,20,507,28, this);
		...
		"eze$$getChildVariables": function() {
			...
			{name: "VALIGN_TOP", value : eze$$parent.VALIGN_TOP, type : "int", jsName : "VALIGN_TOP"},
			{name: "VALIGN_MIDDLE", value : eze$$parent.VALIGN_MIDDLE, type : "int", jsName : "VALIGN_MIDDLE"},
			{name: "VALIGN_BOTTOM", value : eze$$parent.VALIGN_BOTTOM, type : "int", jsName : "VALIGN_BOTTOM"}
			];
		}
	}
);

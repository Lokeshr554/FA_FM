...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TreeNode', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/TreeNode.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,390,77, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,14,470,34, this);
			this.behaviors = null;
			
			egl.atLine(this.eze$$fileName,15,507,20, this);
			this.bgColor = "";
			egl.atLine(this.eze$$fileName,16,530,59, this);
			this.imageURL = "";
			egl.atLine(this.eze$$fileName,17,592,54, this);
			this.image = new egl.com.ibm.egl.rui.widgets.Image();
			egl.addEmbeddedWidget(this, "image");
			
			egl.atLine(this.eze$$fileName,20,649,14, this);
			this.span = new egl.com.ibm.egl.rui.widgets.Span();
			egl.addEmbeddedWidget(this, "span");
			
			egl.atLine(this.eze$$fileName,21,666,22, this);
			this.childNodes = null;
			
			egl.atLine(this.eze$$fileName,22,691,26, this);
			this.childrenContainer = new egl.com.ibm.egl.rui.widgets.Div();
			egl.addEmbeddedWidget(this, "childrenContainer");
			
			egl.atLine(this.eze$$fileName,23,720,179, this);
			this.nodeContainer = new egl.com.ibm.egl.rui.widgets.Div();
			egl.addEmbeddedWidget(this, "nodeContainer");
			
			egl.atLine(this.eze$$fileName,28,902,123, this);
			this.outerContainer = new egl.com.ibm.egl.rui.widgets.Div();
			egl.addEmbeddedWidget(this, "outerContainer");
			
			egl.atLine(this.eze$$fileName,32,1028,38, this);
			this.ignoreChanges = false;
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,11,325,29, this);
			...
			egl.atLine(this.eze$$fileName,15,507,20, this);
			this.bgColor = "";
			egl.atLine(this.eze$$fileName,18,610,30, this);
			egl.checkNull(this.image, "image").setSrc("images/TreeNodeEmpty.gif");
			egl.atLine(this.eze$$fileName,21,666,22, this);
			this.childNodes = [  ].setType( "A;" );
			egl.atLine(this.eze$$fileName,24,744,45, this);
			egl.checkNull(this.nodeContainer, "nodeContainer").setChildren( [ this.image, this.span, this.childrenContainer ] );
			egl.atLine(this.eze$$fileName,25,795,16, this);
			egl.checkNull(this.nodeContainer, "nodeContainer").setPaddingLeft(12);
			egl.atLine(this.eze$$fileName,25,813,25, this);
			egl.checkNull(this.nodeContainer, "nodeContainer").setStyle("text-align: left;");
			egl.atLine(this.eze$$fileName,26,843,50, this);
			egl.checkNull(this.nodeContainer, "nodeContainer").setBackground("url(images/TreeNodeL.gif) no-repeat");
			egl.atLine(this.eze$$fileName,29,927,38, this);
			egl.checkNull(this.outerContainer, "outerContainer").setChildren( [ this.nodeContainer ] );
			egl.atLine(this.eze$$fileName,30,971,49, this);
			egl.checkNull(this.outerContainer, "outerContainer").setBackground("url(images/TreeNodeI.gif) repeat-y");
			egl.atLine(this.eze$$fileName,32,1028,38, this);
			this.ignoreChanges = false;
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,35,1092,39, this);
			egl.checkNull(this.childrenContainer, "childrenContainer").setLogicalParent(  this );
			egl.atLine(this.eze$$fileName,36,1135,27, this);
			egl.checkNull(this.image, "image").setLogicalParent(  this );
			egl.atLine(this.eze$$fileName,37,1166,26, this);
			egl.checkNull(this.span, "span").setLogicalParent(  this );
			egl.atLine(this.eze$$fileName,34,1072,126, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setImageURL": function( imageURL ) {
		...
		try { egl.enter("setImageURL",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("imageURL", imageURL, "string", "imageURL");
			egl.atLine(this.eze$$fileName,41,1249,21, this);
			egl.checkNull(this.image, "image").setSrc(imageURL);
			egl.atLine(this.eze$$fileName,42,1274,17, this);
			egl.checkNull(this.image, "image").setWidth((16).toString());
			egl.atLine(this.eze$$fileName,43,1295,18, this);
			egl.checkNull(this.image, "image").setHeight((16).toString());
			egl.atLine(this.eze$$fileName,40,1204,115, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setChildren": function( newChildren ) {
		...
		try { egl.enter("setChildren",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("newChildren", newChildren, "any[]", "!newChildren");
			egl.atLine(this.eze$$fileName,47,1383,21, this);
			this.ignoreChanges = true;
			egl.atLine(this.eze$$fileName,48,1408,17, this);
			this.removeChildren();
			var childrenCount = 0;
			egl.addLocalFunctionVariable("childrenCount", childrenCount, "int", "childrenCount");
			egl.atLine(this.eze$$fileName,49,1449,21, this);
			var ezert$$1 = 0;
			ezert$$1 = newChildren.getSize();
			egl.atLine(this.eze$$fileName,49,1429,42, this);
			childrenCount = ezert$$1;
			egl.setLocalFunctionVariable("childrenCount", childrenCount, "int");
			egl.atLine(this.eze$$fileName,50,1475,117, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= childrenCount); n = (n + 1) )
					{
						...
						try{egl.enterBlock();
							var child = null;
							egl.addLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode", "child");
							egl.atLine(this.eze$$fileName,51,1520,32, this);
							child = egl.convertAnyToRefType(egl.boxAny(egl.checkNull(newChildren, "newChildren")[newChildren.checkIndex((n)-1)]),"Tcom/ibm/egl/rui/widgets/treenode;",egl.com.ibm.egl.rui.widgets.TreeNode);
							egl.setLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode");
							egl.atLine(this.eze$$fileName,52,1557,28, this);
							this.appendChild(egl.boxAny(egl.checkNull(newChildren, "newChildren")[newChildren.checkIndex((n)-1)]) );
						}finally{egl.exitBlock();}
						egl.atLine(this.eze$$fileName,50,1475,117, this);
					}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,54,1596,22, this);
			this.ignoreChanges = false;
			egl.atLine(this.eze$$fileName,55,1622,18, this);
			this.childrenChanged();
			egl.atLine(this.eze$$fileName,46,1325,321, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getChildren": function() {
		...
		try { egl.enter("getChildren",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,59,1705,20, this);
	...
	"removeChildren": function() {
		...
		try { egl.enter("removeChildren",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,63,1778,23, this);
			this.childNodes.removeAll();
			egl.atLine(this.eze$$fileName,64,1805,35, this);
			egl.checkNull(this.childrenContainer, "childrenContainer").removeChildren();
			egl.atLine(this.eze$$fileName,65,1844,18, this);
			this.childrenChanged();
			egl.atLine(this.eze$$fileName,62,1737,131, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"appendChild": function( child ) {
		...
		try { egl.enter("appendChild",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("child", child, "any", "child");
			egl.atLine(this.eze$$fileName,69,1924,37, this);
			egl.checkNull(this.childrenContainer, "childrenContainer").appendChild(egl.convertAnyToRefType(child,"Tegl/ui/rui/widget;",egl.egl.ui.rui.Widget) );
			var node = null;
			egl.addLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode", "node");
			egl.atLine(this.eze$$fileName,70,1965,22, this);
			...
			egl.atLine(this.eze$$fileName,71,1991,20, this);
			...
			egl.atLine(this.eze$$fileName,72,2015,26, this);
			egl.checkNull(node, "node").setLogicalParent(  this );
			egl.atLine(this.eze$$fileName,73,2045,18, this);
			this.childrenChanged();
			egl.atLine(this.eze$$fileName,68,1874,195, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"childrenChanged": function() {
		...
		try { egl.enter("childrenChanged",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,77,2117,58, this);
			if ( !(this.ignoreChanges) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,78,2141,27, this);
					this.applyBehaviorsToChildren();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,76,2075,106, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,83,2225,43, this);
			if ( (this.span == null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,83,2243,21, this);
					$result = "span=null";
					egl.setLocalFunctionVariable("STRING", $result, "string");
					{ if (!egl.debugg) egl.leave(); return $result;}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,84,2272,24, this);
			$result = egl.checkNull(this.span, "span").getInnerHTML();
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
			if (!egl.debugg){
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,87,2341,22, this);
			egl.checkNull(this.span, "span").setInnerHTML(text);
			egl.atLine(this.eze$$fileName,86,2305,64, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"applyBehaviors": function( behaviors, eze$$behaviors$func_, bgColor, eze$$caller ) {
		...
		try { egl.enter("applyBehaviors",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("behaviors", behaviors, "com.ibm.egl.rui.widgets.TreeNodeBehavior[]", "!behaviors");
			egl.addLocalFunctionVariable("bgColor", bgColor, "string", "bgColor");
			egl.atLine(this.eze$$fileName,91,2451,23, this);
			this.bgColor = bgColor;
			egl.atLine(this.eze$$fileName,92,2482,24, this);
			var ezert$$2 = 0;
			ezert$$2 = this.behaviors.getSize();
			egl.atLine(this.eze$$fileName,92,2478,205, this);
			if ( (ezert$$2 == 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,93,2517,36, this);
					this.behaviors.appendAll( behaviors );
					var behaviorCount = 0;
					egl.addLocalFunctionVariable("behaviorCount", behaviorCount, "int", "behaviorCount");
					egl.atLine(this.eze$$fileName,94,2578,19, this);
					var ezert$$3 = 0;
					ezert$$3 = behaviors.getSize();
					egl.atLine(this.eze$$fileName,94,2558,40, this);
					behaviorCount = ezert$$3;
					egl.setLocalFunctionVariable("behaviorCount", behaviorCount, "int");
					egl.atLine(this.eze$$fileName,95,2603,73, this);
					{
						try{egl.enterBlock();
							var n = 0;
							egl.addLocalFunctionVariable("n", n, "int", "n");
							...
							for ( ; (n <= behaviorCount); n = (n + 1) )
							{
								egl.setLocalFunctionVariable("n", n, "int");
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,96,2649,19, this);
									egl.checkNull(behaviors, "behaviors")[behaviors.checkIndex((n)-1)]( this );
								}finally{egl.exitBlock();}
								egl.atLine(this.eze$$fileName,95,2603,73, this);
							}
						}finally{egl.exitBlock();}
			...
			egl.atLine(this.eze$$fileName,99,2687,27, this);
			this.applyBehaviorsToChildren();
			egl.atLine(this.eze$$fileName,90,2375,345, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"applyBehaviorsToChildren": function() {
		...
		try { egl.enter("applyBehaviorsToChildren",this,arguments,eze$$updater);
			var childrenCount = 0;
			egl.addLocalFunctionVariable("childrenCount", childrenCount, "int", "childrenCount");
			egl.atLine(this.eze$$fileName,103,2785,20, this);
			var ezert$$4 = 0;
			ezert$$4 = this.childNodes.getSize();
			egl.atLine(this.eze$$fileName,103,2765,41, this);
			childrenCount = ezert$$4;
			egl.setLocalFunctionVariable("childrenCount", childrenCount, "int");
			egl.atLine(this.eze$$fileName,104,2810,179, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n <= childrenCount); n = (n + 1) )
					{
						...
						try{egl.enterBlock();
							var child = null;
							egl.addLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode", "child");
							egl.atLine(this.eze$$fileName,105,2855,31, this);
							child = egl.convertAnyToRefType(egl.boxAny(egl.checkNull(this.childNodes, "childNodes")[this.childNodes.checkIndex((n)-1)]),"Tcom/ibm/egl/rui/widgets/treenode;",egl.com.ibm.egl.rui.widgets.TreeNode);
							egl.setLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode");
							egl.atLine(this.eze$$fileName,106,2891,41, this);
							egl.checkNull(child, "child").applyBehaviors(this.behaviors, function(eze$$inout$behaviors) {
								this.behaviors = eze$$inout$behaviors;
							}, this.bgColor, this );
							egl.atLine(this.eze$$fileName,107,2937,44, this);
							egl.checkNull(child, "child").markAsLast((n == childrenCount), this.bgColor );
						}finally{egl.exitBlock();}
						egl.atLine(this.eze$$fileName,104,2810,179, this);
					}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,102,2726,269, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"markAsLast": function( lastNode, bgColor ) {
		...
		try { egl.enter("markAsLast",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("lastNode", lastNode, "boolean", "lastNode");
			egl.addLocalFunctionVariable("bgColor", bgColor, "string", "bgColor");
			egl.atLine(this.eze$$fileName,112,3064,182, this);
			if ( lastNode ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,113,3082,76, this);
					egl.checkNull(this.nodeContainer, "nodeContainer").setBackground((bgColor + " url(images/TreeNodeL.gif) no-repeat"));
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,115,3171,67, this);
					egl.checkNull(this.nodeContainer, "nodeContainer").setBackground(" url(images/TreeNodeL.gif) no-repeat");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,111,3001,251, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setBiDiStyle": function( textLayoutThis, reverseTextDirectionThis ) {
		...
		try { egl.enter("setBiDiStyle",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("textLayoutThis", textLayoutThis, "string", "textLayoutThis");
			egl.addLocalFunctionVariable("reverseTextDirectionThis", reverseTextDirectionThis, "string", "reverseTextDirectionThis");
			egl.atLine(this.eze$$fileName,120,3344,38, this);
			egl.checkNull(this.span, "span").setTextLayout(textLayoutThis);
			egl.atLine(this.eze$$fileName,121,3386,58, this);
			egl.checkNull(this.span, "span").setReverseTextDirection(reverseTextDirectionThis);
			egl.atLine(this.eze$$fileName,122,3448,157, this);
			{
				try{egl.enterBlock();
					var i = 0;
					...
					for ( ; (i <= this.childNodes.getSize()); i = (i + 1) )
					{
						...
						try{egl.enterBlock();
							var child = null;
							egl.addLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode", "child");
							egl.atLine(this.eze$$fileName,123,3500,31, this);
							child = egl.convertAnyToRefType(egl.boxAny(egl.checkNull(this.childNodes, "childNodes")[this.childNodes.checkIndex((i)-1)]),"Tcom/ibm/egl/rui/widgets/treenode;",egl.com.ibm.egl.rui.widgets.TreeNode);
							egl.setLocalFunctionVariable("child", child, "com.ibm.egl.rui.widgets.TreeNode");
							egl.atLine(this.eze$$fileName,124,3538,60, this);
							egl.checkNull(child, "child").setBiDiStyle(textLayoutThis, reverseTextDirectionThis );
						}finally{egl.exitBlock();}
						egl.atLine(this.eze$$fileName,122,3448,157, this);
					}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,119,3258,355, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"eze$$getChildVariables": function() {
		...
		{name: "bgColor", value : eze$$parent.bgColor, type : "string", jsName : "bgColor"},
		{name: "imageURL", value : eze$$parent.imageURL, type : "string", jsName : "imageURL", setter : "setImageURL"},
		{name: "image", value : eze$$parent.image, type : "com.ibm.egl.rui.widgets.Image", jsName : "image"},
		{name: "span", value : eze$$parent.span, type : "com.ibm.egl.rui.widgets.Span", jsName : "span"},
		{name: "childNodes", value : eze$$parent.childNodes, type : "any[]", jsName : "!childNodes"},
		{name: "childrenContainer", value : eze$$parent.childrenContainer, type : "com.ibm.egl.rui.widgets.Div", jsName : "childrenContainer"},
		{name: "nodeContainer", value : eze$$parent.nodeContainer, type : "com.ibm.egl.rui.widgets.Div", jsName : "nodeContainer"},
		{name: "outerContainer", value : eze$$parent.outerContainer, type : "com.ibm.egl.rui.widgets.Div", jsName : "outerContainer"},
		{name: "ignoreChanges", value : eze$$parent.ignoreChanges, type : "boolean", jsName : "ignoreChanges"}
		];
	}
}
);

...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.widgets.DataGridLib');
else egl.eze$$userLibs = ['com.ibm.egl.rui.widgets.DataGridLib'];
egl.defineRUILibrary( 'com.ibm.egl.rui.widgets', 'DataGridLib',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,26,643,21, this);
				this.util = new egl.com.ibm.egl.rui.widgets.DataGridUtil();
				
				this.jsrt$SysVar= new egl.egl.core.SysVar();
				egl.atLine(this.eze$$fileName,14,356,26, this);
				this.ALIGN_RIGHT = 2;
				egl.atLine(this.eze$$fileName,15,385,25, this);
				this.ALIGN_LEFT = 0;
				egl.atLine(this.eze$$fileName,16,414,27, this);
				this.ALIGN_CENTER = 1;
				egl.atLine(this.eze$$fileName,18,447,32, this);
				this.DISABLE_SELECTION = 0;
				egl.atLine(this.eze$$fileName,19,482,31, this);
				this.SINGLE_SELECTION = 1;
				egl.atLine(this.eze$$fileName,20,516,33, this);
				this.MULTIPLE_SELECTION = 2;
				egl.atLine(this.eze$$fileName,22,555,24, this);
				this.SORT_NONE = 0;
				egl.atLine(this.eze$$fileName,23,585,24, this);
				this.SORT_DOWN = 1;
				egl.atLine(this.eze$$fileName,24,615,22, this);
				this.SORT_UP = 2;
				if (!egl.debugg) egl.leave();
			} finally {
				if (!egl.debugg){
		...
		"eze$$getChildVariables": function() {
			...
			{name: "ALIGN_RIGHT", value : eze$$parent.ALIGN_RIGHT, type : "int", jsName : "ALIGN_RIGHT"},
			{name: "ALIGN_LEFT", value : eze$$parent.ALIGN_LEFT, type : "int", jsName : "ALIGN_LEFT"},
			{name: "ALIGN_CENTER", value : eze$$parent.ALIGN_CENTER, type : "int", jsName : "ALIGN_CENTER"},
			{name: "DISABLE_SELECTION", value : eze$$parent.DISABLE_SELECTION, type : "int", jsName : "DISABLE_SELECTION"},
			{name: "SINGLE_SELECTION", value : eze$$parent.SINGLE_SELECTION, type : "int", jsName : "SINGLE_SELECTION"},
			{name: "MULTIPLE_SELECTION", value : eze$$parent.MULTIPLE_SELECTION, type : "int", jsName : "MULTIPLE_SELECTION"},
			{name: "SORT_NONE", value : eze$$parent.SORT_NONE, type : "int", jsName : "SORT_NONE"},
			{name: "SORT_DOWN", value : eze$$parent.SORT_DOWN, type : "int", jsName : "SORT_DOWN"},
			{name: "SORT_UP", value : eze$$parent.SORT_UP, type : "int", jsName : "SORT_UP"},

...
egl.defineClass('com.ibm.egl.rui.widgets', 'DataGridSorter', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/DataGridSorter.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,16,392,18, this);
			this.sortByName = "";
			egl.atLine(this.eze$$fileName,17,413,25, this);
			this.sortingUp = false;
			egl.atLine(this.eze$$fileName,18,441,27, this);
	...
	"columnSorter": function( grid, td, ignoreRow, ignoreDataIndex, column ) {
		...
		try { egl.enter("columnSorter",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,21,598,25, this);
			egl.checkNull(grid, "grid").setEnableSorting(false);
			egl.atLine(this.eze$$fileName,22,627,26, this);
			...
			egl.atLine(this.eze$$fileName,20,473,186, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"sortColumn": function( e ) {
		...
		try { egl.enter("sortColumn",this,arguments,eze$$updater);
			...
			var td = null;
			egl.addLocalFunctionVariable("td", td, "egl.ui.rui.Widget", "td");
			egl.atLine(this.eze$$fileName,26,700,21, this);
			td = e.widget;
			egl.setLocalFunctionVariable("td", td, "egl.ui.rui.Widget");
			var grid = null;
			egl.addLocalFunctionVariable("grid", grid, "com.ibm.egl.rui.widgets.DataGrid", "grid");
			egl.atLine(this.eze$$fileName,27,725,31, this);
			{
			...
			egl.atLine(this.eze$$fileName,28,773,25, this);
			var ezert$$1 = null;
			ezert$$1 = td.getAttribute("column" );
			egl.atLine(this.eze$$fileName,28,760,39, this);
			column = egl.convertAnyToInt(egl.boxAny(ezert$$1),false);
			egl.setLocalFunctionVariable("column", column, "int");
			egl.atLine(this.eze$$fileName,29,803,39, this);
			...
			egl.atLine(this.eze$$fileName,30,846,23, this);
			this.sortingUp = !(this.sortingUp);
			egl.atLine(this.eze$$fileName,31,873,120, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= egl.checkNull(grid, "grid").getColumns().getSize()); n = (n + 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,32,922,64, this);
							if ( (n != column) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,33,944,34, this);
			...
			egl.atLine(this.eze$$fileName,36,997,116, this);
			if ( this.sortingUp ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,37,1015,39, this);
				...
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,39,1067,39, this);
			...
			egl.atLine(this.eze$$fileName,41,1127,72, this);
			var ezert$$2 = null;
			...
			egl.atLine(this.eze$$fileName,41,1117,83, this);
			egl.checkNull(grid, "grid").setData(ezert$$2);
			egl.atLine(this.eze$$fileName,25,665,541, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

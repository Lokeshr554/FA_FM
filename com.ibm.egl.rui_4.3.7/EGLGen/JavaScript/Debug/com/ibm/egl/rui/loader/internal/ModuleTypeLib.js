...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.loader.internal.ModuleTypeLib');
else egl.eze$$userLibs = ['com.ibm.egl.rui.loader.internal.ModuleTypeLib'];
egl.defineRUILibrary( 'com.ibm.egl.rui.loader.internal', 'ModuleTypeLib',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,13,363,29, this);
				this.css = "cssFile";
				egl.atLine(this.eze$$fileName,14,395,39, this);
				this.property = "propertyFile";
				egl.atLine(this.eze$$fileName,15,437,36, this);
				this.imports = "importFile";
				egl.atLine(this.eze$$fileName,16,476,53, this);
				this.runtimeProperty = "runtimePropertyFile";
				egl.atLine(this.eze$$fileName,17,532,37, this);
		...
		"eze$$getChildVariables": function() {
			...
			{name: "css", value : eze$$parent.css, type : "string", jsName : "css"},
			{name: "property", value : eze$$parent.property, type : "string", jsName : "property"},
			{name: "imports", value : eze$$parent.imports, type : "string", jsName : "imports"},
			{name: "runtimeProperty", value : eze$$parent.runtimeProperty, type : "string", jsName : "runtimeProperty"},
			{name: "include", value : eze$$parent.include, type : "string", jsName : "include"}
			];
		}
	}
);

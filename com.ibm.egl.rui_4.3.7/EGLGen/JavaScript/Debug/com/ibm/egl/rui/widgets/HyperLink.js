...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'HyperLink', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/HyperLink.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,19,553,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,20,641,91, this);
			this.target = "";
			egl.atLine(this.eze$$fileName,21,735,85, this);
			this.href = "";
			egl.atLine(this.eze$$fileName,22,823,43, this);
			this.hyperChild = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "hyperChild");
			
			egl.atLine(this.eze$$fileName,23,869,69, this);
			this.hyperParent = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "hyperParent");
			
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,11,325,26, this);
			this.targetWidget = this.hyperParent;
			egl.atLine(this.eze$$fileName,22,850,13, this);
			this.hyperChild.setTagName( "a" );
			egl.atLine(this.eze$$fileName,23,896,15, this);
			this.hyperParent.setTagName( "div" );
			egl.atLine(this.eze$$fileName,23,913,23, this);
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,26,983,14, this);
			$result = this.text;
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,29,1044,14, this);
			this.text = textIn;
			egl.atLine(this.eze$$fileName,30,1062,28, this);
			this.hyperChild.setInnerHTML( this.text );
			egl.atLine(this.eze$$fileName,28,1006,90, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTarget": function() {
		...
		try { egl.enter("getTarget",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,34,1143,16, this);
			$result = this.target;
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"setTarget": function( targetIn ) {
		...
		try { egl.enter("setTarget",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("targetIn", targetIn, "string", "targetIn");
			egl.atLine(this.eze$$fileName,37,1210,18, this);
			this.target = targetIn;
			egl.atLine(this.eze$$fileName,38,1232,42, this);
			this.hyperChild.setAttribute("target", this.target );
			egl.atLine(this.eze$$fileName,36,1168,112, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getHref": function() {
		...
		try { egl.enter("getHref",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,42,1325,14, this);
			$result = this.href;
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"setHref": function( hrefIn ) {
		...
		try { egl.enter("setHref",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("hrefIn", hrefIn, "string", "hrefIn");
			egl.atLine(this.eze$$fileName,45,1386,14, this);
			this.href = hrefIn;
			egl.atLine(this.eze$$fileName,46,1404,38, this);
			this.hyperChild.setAttribute("href", this.href );
			egl.atLine(this.eze$$fileName,44,1348,100, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"eze$$getChildVariables": function() {
		...
		{name: "target", value : function(){try{return eze$$parent.getTarget();}catch(e){return null;}}(), type : "string", jsName : "target", getter : "getTarget", setter : "setTarget"},
		{name: "href", value : function(){try{return eze$$parent.getHref();}catch(e){return null;}}(), type : "string", jsName : "href", getter : "getHref", setter : "setHref"},
		{name: "hyperChild", value : eze$$parent.hyperChild, type : "egl.ui.rui.Widget", jsName : "hyperChild"},
		{name: "hyperParent", value : eze$$parent.hyperParent, type : "egl.ui.rui.Widget", jsName : "hyperParent"}
		];
	}
}
);

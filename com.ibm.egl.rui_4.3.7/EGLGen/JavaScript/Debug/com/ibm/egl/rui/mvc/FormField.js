...
egl.defineClass(  "com.ibm.egl.rui.mvc", "FormField", "egl.jsrt", "Record", {
	...
	"eze$$getName": function() {
		return "com.ibm.egl.rui.mvc.FormField";
	}
	,
	"eze$$getChildVariables": function() {
		return [
		{name: "displayName", value : this.displayName, type : "string?", jsName : "displayName"},
		{name: "controller", value : this.controller, type : "com.ibm.egl.rui.mvc.Controller", jsName : "controller"},
		{name: "nameLabel", value : this.nameLabel, type : "com.ibm.egl.rui.widgets.TextLabel", jsName : "nameLabel"},
		{name: "errorLabel", value : this.errorLabel, type : "com.ibm.egl.rui.widgets.TextLabel", jsName : "errorLabel"},
		{name: "labelClass", value : this.labelClass, type : "string?", jsName : "labelClass"}
		];
	}
	,

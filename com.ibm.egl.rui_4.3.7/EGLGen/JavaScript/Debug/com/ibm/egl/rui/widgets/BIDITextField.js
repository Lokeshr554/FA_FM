...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'BIDITextField', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/BIDITextField.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,19,594,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,20,682,94, this);
			this.readOnly = false;
			egl.atLine(this.eze$$fileName,22,782,47, this);
			this.reverseTextDirectionThis = "";
			egl.atLine(this.eze$$fileName,23,832,42, this);
			this.widgetOrientationThis = "";
			egl.atLine(this.eze$$fileName,24,877,42, this);
			this.textLayoutThis = "";
			egl.atLine(this.eze$$fileName,25,922,39, this);
			this.handlers = null;
			
			egl.atLine(this.eze$$fileName,27,970,22, this);
			this.error = false;
			egl.atLine(this.eze$$fileName,29,998,36, this);
			this.savedBackgroundColor = "";
			egl.atLine(this.eze$$fileName,30,1037,37, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,33,1100,34, this);
			...
			egl.atLine(this.eze$$fileName,34,1138,33, this);
			...
			egl.atLine(this.eze$$fileName,35,1175,16, this);
			this.setBorderWidth(1);
			egl.atLine(this.eze$$fileName,36,1195,22, this);
			this.setBorderStyle("solid");
			egl.atLine(this.eze$$fileName,37,1221,24, this);
			this.setBorderColor("#7f9db9");
			egl.atLine(this.eze$$fileName,32,1080,171, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enableSelection": function( e ) {
		...
		try { egl.enter("enableSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,41,1320,32, this);
			var ezert$$1 = false;
			ezert$$1 = egl.egl.ui.rui.RUILib['$inst'].getTextSelectionEnabled();
			egl.atLine(this.eze$$fileName,41,1297,56, this);
			this.savedEnableSelection = ezert$$1;
			egl.atLine(this.eze$$fileName,42,1357,37, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(true );
			egl.atLine(this.eze$$fileName,40,1257,143, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"disableSelection": function( e ) {
		...
		try { egl.enter("disableSelection",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,46,1447,53, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(this.savedEnableSelection );
			egl.atLine(this.eze$$fileName,45,1406,100, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReadOnly": function() {
		...
		try { egl.enter("getReadOnly",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,50,1563,17, this);
	...
	"setReadOnly": function( ro ) {
		...
		try { egl.enter("setReadOnly",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,54,1639,14, this);
			this.readOnly = ro;
			egl.atLine(this.eze$$fileName,55,1657,293, this);
			if ( this.readOnly ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,56,1674,33, this);
					this.setAttribute("readOnly", {eze$$value : "true", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,57,1712,39, this);
					this.savedBackgroundColor = this.getBackgroundColor();
					egl.atLine(this.eze$$fileName,58,1756,23, this);
					this.setBackgroundColor(String('',null));
					egl.atLine(this.eze$$fileName,59,1784,38, this);
					this.setClass("EglRuiBIDITextFieldReadOnly");
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,61,1835,29, this);
					this.setAttribute("readOnly", {eze$$value : "", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,62,1869,39, this);
					this.setBackgroundColor(this.savedBackgroundColor);
					egl.atLine(this.eze$$fileName,63,1913,30, this);
					this.setClass("EglRuiBIDITextField");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,53,1592,364, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( txt ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,68,2006,11, this);
			this.text = txt;
			egl.atLine(this.eze$$fileName,69,2021,27, this);
			this.setAttribute("value", {eze$$value : txt, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,70,2052,16, this);
			this.setBidiStyles();
			egl.atLine(this.eze$$fileName,71,2072,14, this);
			this.reverseText();
			egl.atLine(this.eze$$fileName,67,1961,133, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,75,2147,71, this);
			if ( (this.textLayoutThis == "Visual") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,76,2187,24, this);
					this.cleanBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,78,2222,14, this);
			this.reverseText();
			var ezert$$2 = null;
			ezert$$2 = this.getAttribute("value" );
			egl.atLine(this.eze$$fileName,79,2240,29, this);
			this.text = egl.convertAnyToString(ezert$$2,false);
			egl.atLine(this.eze$$fileName,80,2273,14, this);
			$result = this.text;
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,84,2382,53, this);
			this.reverseTextDirectionThis = reverseTextDirection;
			egl.atLine(this.eze$$fileName,85,2439,14, this);
			this.reverseText();
			egl.atLine(this.eze$$fileName,83,2298,163, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,89,2536,39, this);
	...
	"getWidgetOrientation": function() {
		...
		try { egl.enter("getWidgetOrientation",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,93,2652,36, this);
	...
	"setWidgetOrientation": function( widgetOrientation ) {
		...
		try { egl.enter("setWidgetOrientation",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,97,2776,47, this);
			this.widgetOrientationThis = widgetOrientation;
			egl.atLine(this.eze$$fileName,98,2827,16, this);
			this.setBidiStyles();
			egl.atLine(this.eze$$fileName,96,2700,151, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setTextLayout": function( textLayout ) {
		...
		try { egl.enter("setTextLayout",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,102,2923,33, this);
			this.textLayoutThis = textLayout;
			egl.atLine(this.eze$$fileName,103,2960,16, this);
			this.setBidiStyles();
			egl.atLine(this.eze$$fileName,105,2983,64, this);
			if ( (this.handlers == null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,106,3008,32, this);
			...
			egl.atLine(this.eze$$fileName,108,3054,30, this);
			this.handlers.AttachHandlers( this );
			egl.atLine(this.eze$$fileName,109,3088,14, this);
			this.reverseText();
			egl.atLine(this.eze$$fileName,101,2859,249, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTextLayout": function() {
		...
		try { egl.enter("getTextLayout",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,113,3174,29, this);
	...
	"setBidiStyles": function() {
		...
		try { egl.enter("setBidiStyles",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,117,3243,51, this);
			...
			egl.atLine(this.eze$$fileName,118,3298,69, this);
			...
			egl.atLine(this.eze$$fileName,119,3373,52, this);
			this.setBiDiStyles(isVisual, isWidgetOrientationRTL );
			egl.atLine(this.eze$$fileName,116,3215,218, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"reverseText": function() {
		...
		try { egl.enter("reverseText",this,arguments,eze$$updater);
			var isVisual = false;
			egl.addLocalFunctionVariable("isVisual", isVisual, "boolean", "isVisual");
			egl.atLine(this.eze$$fileName,123,3465,51, this);
			isVisual = (this.textLayoutThis == "Visual");
			egl.setLocalFunctionVariable("isVisual", isVisual, "boolean");
			...
			egl.atLine(this.eze$$fileName,124,3520,68, this);
			...
			egl.atLine(this.eze$$fileName,125,3597,146, this);
			if ( (isVisual && isReverseDirection) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,126,3636,66, this);
					if ( (this.handlers == null) ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,127,3662,32, this);
							this.handlers = (function () {
					...
					egl.atLine(this.eze$$fileName,129,3709,27, this);
					this.handlers.ReverseText( this );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,122,3439,310, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Button', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,21,603,83, this);
			this.text = "";
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,24,737,14, this);
			this.text = textIn;
			egl.atLine(this.eze$$fileName,25,755,30, this);
			this.setAttribute("value", {eze$$value : textIn, eze$$signature : "S;"} );
			var isVisual = false;
			egl.addLocalFunctionVariable("isVisual", isVisual, "boolean", "isVisual");
			egl.atLine(this.eze$$fileName,26,789,47, this);
			...
			egl.atLine(this.eze$$fileName,27,840,64, this);
			...
			egl.atLine(this.eze$$fileName,28,910,96, this);
			if ( (isVisual || isReverseDirection) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,29,949,50, this);
					this.setBiDiMarkers(isVisual, isReverseDirection );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,23,691,323, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,34,1067,105, this);
			if ( ((this.getTextLayout() == "Visual") || (this.getReverseTextDirection() == "Yes")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,35,1141,24, this);
					this.cleanBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			var ezert$$1 = null;
			ezert$$1 = this.getAttribute("value" );
			egl.atLine(this.eze$$fileName,37,1179,42, this);
			var ezert$$2 = null;
			ezert$$2 = ezert$$1;
			$result = egl.convertAnyToString(ezert$$2,false);

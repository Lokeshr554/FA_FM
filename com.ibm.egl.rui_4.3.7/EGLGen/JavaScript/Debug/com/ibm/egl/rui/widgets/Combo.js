...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Combo', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/Combo.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,37,1049,93, this);
			this.values = (function(){ var ezert$$1= []; ezert$$1.setType( "S;" );// no max size set for this array
			return ezert$$1;})();
			
			egl.atLine(this.eze$$fileName,38,1145,97, this);
			this.selection = 0;
			egl.atLine(this.eze$$fileName,39,1245,47, this);
			this.reverseTextDirectionThis = "";
			egl.atLine(this.eze$$fileName,40,1295,42, this);
			this.textLayoutThis = "";
			egl.atLine(this.eze$$fileName,42,1343,26, this);
	...
	"setValues": function( value ) {
		...
		try { egl.enter("setValues",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,45,1416,15, this);
			this.values = value;
			egl.atLine(this.eze$$fileName,46,1435,17, this);
			this.removeChildren();
			egl.atLine(this.eze$$fileName,47,1456,84, this);
			{
				try{egl.enterBlock();
					var i = 0;
					...
					for ( ; (i <= this.options.getSize()); i = (i + 1) )
					{
						egl.setLocalFunctionVariable("i", i, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,48,1499,34, this);
			...
			egl.atLine(this.eze$$fileName,50,1544,20, this);
			this.options.removeAll();
			egl.atLine(this.eze$$fileName,51,1568,201, this);
			{
				try{egl.enterBlock();
					var index = 0;
					...
					for ( ; (index <= value.getSize()); index = (index + 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,52,1645,18, this);
							option.setTagName( "option" );
							egl.atLine(this.eze$$fileName,53,1670,32, this);
							option.setInnerHTML( egl.checkNull(value, "value")[value.checkIndex((index)-1)] );
							egl.atLine(this.eze$$fileName,54,1707,30, this);
							this.options.appendElement( option );
							egl.atLine(this.eze$$fileName,55,1742,20, this);
			...
			egl.atLine(this.eze$$fileName,57,1773,16, this);
			this.setSelection(1 );
			egl.atLine(this.eze$$fileName,59,1795,108, this);
			if ( ((this.textLayoutThis == "Visual") || (this.reverseTextDirectionThis == "Yes")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,60,1879,17, this);
					this.setBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,63,1914,26, this);
			var ezert$$3 = false;
			ezert$$3 = (function () {
				var ezert$$4 = new egl.com.ibm.egl.rui.history.HistoryHelper();
				return ezert$$4;
			}).call(this).isIE();
			egl.atLine(this.eze$$fileName,63,1909,112, this);
			if ( (ezert$$3 && egl.isa(this.getLogicalParent(), "Tcom/ibm/egl/rui/widgets/box;")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,64,1977,37, this);
					egl.checkNull(this.getLogicalParent(), "logicalParent as Box").layout();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,44,1375,652, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getValues": function() {
		...
		try { egl.enter("getValues",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,69,2076,16, this);
			$result = this.values;
	...
	"setSelection": function( selection ) {
		...
		try { egl.enter("setSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,73,2151,47, this);
			if ( (selection > 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,73,2181,17, this);
					var ezert$$5 = 0;
					ezert$$5 = this.options.getSize();
					egl.atLine(this.eze$$fileName,73,2151,47, this);
					if ( (selection <= ezert$$5) ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,73,2151,47, this);
			...
			egl.atLine(this.eze$$fileName,73,2147,116, this);
			if ( eze_Cond_Temp_0 ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,74,2204,52, this);
					egl.checkNull(this.options, "options")[this.options.checkIndex((selection)-1)].setAttribute("selected", "true" );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,72,2104,165, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSelection": function() {
		...
		try { egl.enter("getSelection",this,arguments,eze$$updater);
			var $result = 0;
			var ezert$$6 = null;
			ezert$$6 = this.getAttribute("selectedIndex" );
			egl.atLine(this.eze$$fileName,79,2316,52, this);
			var ezert$$7 = null;
			ezert$$7 = ezert$$6;
			$result = (egl.convertAnyToInt(ezert$$7,false) + 1);
	...
	"setTextLayout": function( textLayout ) {
		...
		try { egl.enter("setTextLayout",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,83,2442,33, this);
			this.textLayoutThis = textLayout;
			egl.atLine(this.eze$$fileName,84,2480,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,82,2380,123, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTextLayout": function() {
		...
		try { egl.enter("getTextLayout",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,88,2568,29, this);
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,92,2690,53, this);
			this.reverseTextDirectionThis = reverseTextDirection;
			egl.atLine(this.eze$$fileName,93,2750,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,91,2608,165, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,97,2848,39, this);
	...
	"setBiDiMarkers": function() {
		...
		try { egl.enter("setBiDiMarkers",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,101,2937,51, this);
			...
			egl.atLine(this.eze$$fileName,102,2992,68, this);
			...
			egl.atLine(this.eze$$fileName,103,3066,121, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.options.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,104,3121,59, this);
			...
			egl.atLine(this.eze$$fileName,100,2900,293, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setValueAsText": function( value ) {
		...
		try { egl.enter("setValueAsText",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("value", value, "string", "value");
			egl.atLine(this.eze$$fileName,109,3252,131, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.values.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,110,3303,73, this);
							if ( (value == egl.checkNull(this.values, "values")[this.values.checkIndex((index)-1)]) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,111,3335,20, this);
									this.setSelection(index );
									egl.atLine(this.eze$$fileName,112,3361,7, this);
			...
			egl.atLine(this.eze$$fileName,115,3390,16, this);
			var ezert$$8 = 0;
			ezert$$8 = this.values.getSize();
			egl.atLine(this.eze$$fileName,115,3387,51, this);
			if ( (ezert$$8 > 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,116,3414,16, this);
					this.setSelection(1 );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,108,3200,244, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getValueAsText": function() {
		...
		try { egl.enter("getValueAsText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,121,3518,14, this);
			var ezert$$9 = 0;
			ezert$$9 = this.getSelection();
			egl.atLine(this.eze$$fileName,121,3503,32, this);
			var ezert$$10 = 0;
			ezert$$10 = ezert$$9;
			$result = egl.checkNull(this.values, "values")[this.values.checkIndex((ezert$$10)-1)];
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
			if (!egl.debugg){

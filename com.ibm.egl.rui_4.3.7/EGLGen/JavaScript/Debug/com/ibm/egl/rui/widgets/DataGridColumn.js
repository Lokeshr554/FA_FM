...
egl.defineClass('com.ibm.egl.rui.widgets', 'DataGridColumn', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,16,484,12, this);
			this.name = "";
			egl.atLine(this.eze$$fileName,17,499,20, this);
			this.displayName = null;
			egl.atLine(this.eze$$fileName,18,522,13, this);
			this.width = "";
			egl.atLine(this.eze$$fileName,24,588,20, this);
			this.headerAlignment = 0;
			egl.atLine(this.eze$$fileName,25,611,14, this);
			this.alignment = 0;
			egl.atLine(this.eze$$fileName,27,631,29, this);
			this.enableSorting = false;
			egl.atLine(this.eze$$fileName,29,666,28, this);
			...
			egl.atLine(this.eze$$fileName,30,698,34, this);
			this.columnComparator = null;
			
			egl.atLine(this.eze$$fileName,32,739,18, this);
			this.sortDirection = 0;
			egl.atLine(this.eze$$fileName,33,760,26, this);

...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.mvc.InternalTimeFormatter');
else egl.eze$$userLibs = ['com.ibm.egl.rui.mvc.InternalTimeFormatter'];
egl.defineRUILibrary( 'com.ibm.egl.rui.mvc', 'InternalTimeFormatter',
	{
		'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/mvc/InternalTimeFormatter.egl',
		...
		"format": function( input, format, typeChkMsgKey ) {
			...
			try { egl.enter("format",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,15,444,39, this);
				if ( (input == "") ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,16,465,11, this);
						$result = "";
						egl.setLocalFunctionVariable("STRING", $result, "string");
						{ if (!egl.debugg) egl.leave(); return $result;}
					}finally{egl.exitBlock();}
				}
				egl.atLine(this.eze$$fileName,19,491,63, this);
				if ( (format == "") ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,20,513,34, this);
						format = egl.egl.core.StrLib['$inst'].defaultTimeFormat;
						egl.setLocalFunctionVariable("format", format, "string");
					}finally{egl.exitBlock();}
				}
				egl.atLine(this.eze$$fileName,23,562,257, this);
				try {
					try{egl.enterBlock();
						var timeInput = egl.egl.core.$DateTimeLib.currentTime();
						egl.addLocalFunctionVariable("timeInput", timeInput, "time", "timeInput");
						egl.atLine(this.eze$$fileName,24,570,23, this);
						timeInput = egl.egl.core.$DateTimeLib.timeValue(input);
						egl.setLocalFunctionVariable("timeInput", timeInput, "time");
						egl.atLine(this.eze$$fileName,25,605,36, this);
						var ezert$$1 = null;
						ezert$$1 = egl.egl.core.$StrLib.formatTime( timeInput, format );
						egl.atLine(this.eze$$fileName,25,598,45, this);
				...
				egl.atLine(this.eze$$fileName,14,349,476, this);
				{ if (!egl.debugg) egl.leave(); return $result;}
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"unformat": function( input, format, typeChkMsgKey ) {
			...
			try { egl.enter("unformat",this,arguments,eze$$updater);
				...
				egl.addLocalFunctionVariable("format", format, "string", "format");
				egl.addLocalFunctionVariable("typeChkMsgKey", typeChkMsgKey, "string", "typeChkMsgKey");
				egl.atLine(this.eze$$fileName,32,928,39, this);
				if ( (input == "") ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,33,949,11, this);
						$result = "";
						egl.setLocalFunctionVariable("STRING", $result, "string");
						{ if (!egl.debugg) egl.leave(); return $result;}
					}finally{egl.exitBlock();}
				}
				egl.atLine(this.eze$$fileName,36,975,63, this);
				if ( (format == "") ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,37,997,34, this);
						format = egl.egl.core.StrLib['$inst'].defaultTimeFormat;
						egl.setLocalFunctionVariable("format", format, "string");
					}finally{egl.exitBlock();}
				}
				...
				egl.atLine(this.eze$$fileName,40,1046,46, this);
				savedFormat = egl.egl.core.StrLib['$inst'].defaultTimeFormat;
				egl.setLocalFunctionVariable("savedFormat", savedFormat, "string");
				egl.atLine(this.eze$$fileName,41,1096,419, this);
				try {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,42,1104,34, this);
						egl.egl.core.StrLib['$inst'].defaultTimeFormat = format;
						var result = egl.egl.core.$DateTimeLib.currentTime();
						egl.addLocalFunctionVariable("result", result, "time", "result");
						egl.atLine(this.eze$$fileName,43,1143,20, this);
						result = egl.egl.core.$DateTimeLib.timeValue(input);
						egl.setLocalFunctionVariable("result", result, "time");
						egl.atLine(this.eze$$fileName,44,1168,39, this);
						egl.egl.core.StrLib['$inst'].defaultTimeFormat = savedFormat;
						egl.atLine(this.eze$$fileName,45,1212,25, this);
				...
				{
					{
						...
						try{egl.enterBlock();
							...
							try{egl.enterBlock();
								...
								egl.atLine(this.eze$$fileName,47,1281,46, this);
								errorFormat = egl.egl.core.StrLib['$inst'].defaultTimeFormat;
								egl.setLocalFunctionVariable("errorFormat", errorFormat, "string");
								egl.atLine(this.eze$$fileName,48,1332,39, this);
								egl.egl.core.StrLib['$inst'].defaultTimeFormat = savedFormat;
								egl.atLine(this.eze$$fileName,49,1376,132, this);
								throw (function () {
									var ezert$$6 = egl.createRuntimeException();
									egl.atLine(this.eze$$fileName,49,1414,66, this);
									var ezert$$7 = "";
									...
									egl.atLine(this.eze$$fileName,49,1404,76, this);
									egl.checkNull(ezert$$6, "ezert$$6").message = ezert$$7;
									egl.atLine(this.eze$$fileName,49,1482,24, this);
				...
				egl.atLine(this.eze$$fileName,31,831,690, this);
				{ if (!egl.debugg) egl.leave(); return $result;}
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }

...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TextArea', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/TextArea.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,41,1326,36, this);
			this.savedBackgroundColor = "";
			egl.atLine(this.eze$$fileName,43,1368,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,44,1456,94, this);
			this.readOnly = false;
			egl.atLine(this.eze$$fileName,45,1553,91, this);
			this.numRows = 0;
			egl.atLine(this.eze$$fileName,46,1647,100, this);
			this.numColumns = 0;
			egl.atLine(this.eze$$fileName,48,1753,25, this);
			...
			egl.atLine(this.eze$$fileName,49,1781,30, this);
			this.redraw = false;
			egl.atLine(this.eze$$fileName,50,1814,37, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,53,1877,34, this);
			this.getOnFocusGained().appendElement( new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.TextArea.prototype.enableSelection,"enableSelection") );
			egl.atLine(this.eze$$fileName,54,1915,33, this);
			this.getOnFocusLost().appendElement( new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.TextArea.prototype.disableSelection,"disableSelection") );
			egl.atLine(this.eze$$fileName,52,1857,97, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enableSelection": function( e ) {
		...
		try { egl.enter("enableSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,58,2023,32, this);
			var ezert$$2 = false;
			ezert$$2 = egl.egl.ui.rui.RUILib['$inst'].getTextSelectionEnabled();
			egl.atLine(this.eze$$fileName,58,2000,56, this);
			this.savedEnableSelection = ezert$$2;
			egl.atLine(this.eze$$fileName,59,2060,37, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(true );
			egl.atLine(this.eze$$fileName,57,1960,143, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"disableSelection": function( e ) {
		...
		try { egl.enter("disableSelection",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,63,2150,53, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(this.savedEnableSelection );
			egl.atLine(this.eze$$fileName,62,2109,100, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"append": function( text ) {
		...
		try { egl.enter("append",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,67,2250,88, this);
			if ( this.redraw ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,68,2273,9, this);
					var ezert$$3 = "";
					ezert$$3 = this.getText();
					egl.atLine(this.eze$$fileName,68,2265,26, this);
					this.setText((ezert$$3 + text) );
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,70,2304,27, this);
					this.buffer.appendElement( text );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,66,2215,129, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setRedraw": function( draw ) {
		...
		try { egl.enter("setRedraw",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,75,2389,14, this);
			this.redraw = draw;
			var bufSize = 0;
			egl.addLocalFunctionVariable("bufSize", bufSize, "int", "bufSize");
			egl.atLine(this.eze$$fileName,76,2421,16, this);
			var ezert$$4 = 0;
			ezert$$4 = this.buffer.getSize();
			egl.atLine(this.eze$$fileName,76,2407,31, this);
			bufSize = ezert$$4;
			egl.setLocalFunctionVariable("bufSize", bufSize, "int");
			egl.atLine(this.eze$$fileName,77,2442,158, this);
			if ( (this.redraw && (bufSize > 0)) ) {
				try{egl.enterBlock();
					var s = "";
					egl.addLocalFunctionVariable("s", s, "string", "s");
					egl.atLine(this.eze$$fileName,79,2486,64, this);
					{
						try{egl.enterBlock();
							var i = 0;
							...
							for ( ; (i <= bufSize); i = (i + 1) )
							{
								egl.setLocalFunctionVariable("i", i, "int");
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,80,2520,22, this);
					...
					egl.atLine(this.eze$$fileName,82,2555,10, this);
					this.append(s );
					egl.atLine(this.eze$$fileName,83,2570,23, this);
			...
			egl.atLine(this.eze$$fileName,74,2350,256, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getNumRows": function() {
		...
		try { egl.enter("getNumRows",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,88,2649,38, this);
			this.numRows = egl.convertAnyToInt(ezert$$6,false);
			egl.atLine(this.eze$$fileName,89,2691,17, this);
			$result = this.numRows;
	...
	"setNumRows": function( rows ) {
		...
		try { egl.enter("setNumRows",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,93,2756,15, this);
			this.numRows = rows;
			egl.atLine(this.eze$$fileName,94,2775,27, this);
			this.setAttribute("rows", {eze$$value : rows, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,92,2720,88, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getNumColumns": function() {
		...
		try { egl.enter("getNumColumns",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,98,2855,41, this);
			this.numColumns = egl.convertAnyToInt(ezert$$7,false);
			egl.atLine(this.eze$$fileName,99,2900,19, this);
	...
	"setNumColumns": function( cols ) {
		...
		try { egl.enter("setNumColumns",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,103,2970,18, this);
			this.numColumns = cols;
			egl.atLine(this.eze$$fileName,104,2992,27, this);
			this.setAttribute("cols", {eze$$value : cols, eze$$signature : "I;"} );
			egl.atLine(this.eze$$fileName,102,2931,94, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("text", text, "string", "text");
			egl.atLine(this.eze$$fileName,108,3075,28, this);
			this.setAttribute("value", {eze$$value : text, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,107,3031,80, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,112,3164,41, this);
			var ezert$$9 = null;
			ezert$$9 = ezert$$8;
			$result = egl.convertAnyToString(ezert$$9,false);
	...
	"getReadOnly": function() {
		...
		try { egl.enter("getReadOnly",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,116,3268,17, this);
	...
	"setReadOnly": function( ro ) {
		...
		try { egl.enter("setReadOnly",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,120,3343,14, this);
			this.readOnly = ro;
			egl.atLine(this.eze$$fileName,121,3361,276, this);
			if ( ro ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,122,3372,33, this);
					this.setAttribute("readOnly", {eze$$value : "true", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,123,3410,39, this);
					this.savedBackgroundColor = this.getBackgroundColor();
					egl.atLine(this.eze$$fileName,124,3454,23, this);
					this.setBackgroundColor(String('',null));
					egl.atLine(this.eze$$fileName,125,3482,33, this);
					this.setClass("EglRuiTextAreaReadOnly");
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,127,3528,28, this);
					this.removeAttribute("readOnly" );
					egl.atLine(this.eze$$fileName,128,3561,39, this);
					this.setBackgroundColor(this.savedBackgroundColor);
					egl.atLine(this.eze$$fileName,129,3605,25, this);
					this.setClass("EglRuiTextArea");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,119,3296,347, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

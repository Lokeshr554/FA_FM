...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Span', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,343,71, this);
			this.text = "";
	...
	"setText": function( textIn ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,16,457,19, this);
			this.setInnerHTML(textIn);
			egl.atLine(this.eze$$fileName,15,419,63, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,20,527,19, this);

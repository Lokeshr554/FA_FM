...
egl.defineRUIWidget('com.ibm.egl.rui.mvc', 'ValidatingForm', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/mvc/ValidatingForm.egl',
	...
	"setEntries": function( entries ) {
		...
		try { egl.enter("setEntries",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,29,760,23, this);
			this.entries = entries;
			egl.atLine(this.eze$$fileName,30,787,585, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= entries.getSize()); n = (n + 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,31,836,74, this);
							egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].nameLabel = (function () {
								var ezert$$2 = new egl.com.ibm.egl.rui.widgets.TextLabel();
								egl.atLine(this.eze$$fileName,31,880,27, this);
								egl.checkNull(ezert$$2, "ezert$$2").setText((function(x){ return x != null ? ((x).toString()) : ""; })(egl.checkNull(entries, "entries")[entries.checkIndex((n)-1)].displayName));
								return ezert$$2;
							}).call(this);
							egl.atLine(this.eze$$fileName,32,915,56, this);
							...
							egl.atLine(this.eze$$fileName,33,976,43, this);
							egl.checkNull(this.box, "box").appendChild(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].nameLabel );
							egl.atLine(this.eze$$fileName,34,1024,49, this);
							egl.checkNull(this.box, "box").appendChild(egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").getView() );
							egl.atLine(this.eze$$fileName,35,1078,100, this);
							egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].errorLabel = (function () {
								var ezert$$3 = new egl.com.ibm.egl.rui.widgets.TextLabel();
								egl.atLine(this.eze$$fileName,35,1123,12, this);
								egl.checkNull(ezert$$3, "ezert$$3").setMarginLeft(9);
								egl.atLine(this.eze$$fileName,35,1137,38, this);
								egl.checkNull(ezert$$3, "ezert$$3").setClass("EglRuiTextLabel FormErrorLabel");
								return ezert$$3;
							}).call(this);
							egl.atLine(this.eze$$fileName,36,1183,44, this);
							egl.checkNull(this.box, "box").appendChild(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].errorLabel );
							egl.atLine(this.eze$$fileName,37,1232,133, this);
							if ( (egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").validStateSetter == null) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,38,1294,63, this);
									egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").validStateSetter = new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.mvc.ValidatingForm.prototype.validStateSetter,"validStateSetter");
			...
			egl.atLine(this.eze$$fileName,41,1376,17, this);
			this.appendChild(this.box );
			egl.atLine(this.eze$$fileName,28,713,686, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getEntries": function() {
		...
		try { egl.enter("getEntries",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,45,1451,17, this);
			$result = this.entries;
	...
	"commit": function() {
		...
		try { egl.enter("commit",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,49,1503,239, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					var ezert$$4 = 0;
					ezert$$4 = this.entries.getSize();
					n = ezert$$4;
					egl.setLocalFunctionVariable("n", n, "int");
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,50,1562,31, this);
							...
							egl.atLine(this.eze$$fileName,51,1611,39, this);
							var ezert$$5 = null;
							ezert$$5 = egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").getErrorMessage();
							egl.atLine(this.eze$$fileName,51,1598,53, this);
							msg = (function(x){ return x != null ? ((x).toString()) : ""; })(ezert$$5);
							egl.setLocalFunctionVariable("msg", msg, "string");
							egl.atLine(this.eze$$fileName,52,1656,79, this);
							if ( !(((msg == null) || (msg == ""))) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,53,1694,33, this);
			...
			egl.atLine(this.eze$$fileName,48,1482,266, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"publish": function() {
		...
		try { egl.enter("publish",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,59,1776,98, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,60,1835,32, this);
			...
			egl.atLine(this.eze$$fileName,58,1754,129, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"isValid": function() {
		...
		try { egl.enter("isValid",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,65,1928,22, this);
			result = true;
			egl.setLocalFunctionVariable("result", result, "boolean");
			egl.atLine(this.eze$$fileName,66,1954,136, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
			...
			egl.atLine(this.eze$$fileName,71,2096,15, this);
			$result = result;
	...
	"isFormValid": function() {
		...
		try { egl.enter("isFormValid",this,arguments,eze$$updater);
			var $result = false;
			var result = false;
			egl.addLocalFunctionVariable("result", result, "boolean", "result");
			egl.atLine(this.eze$$fileName,75,2166,22, this);
			result = true;
			egl.setLocalFunctionVariable("result", result, "boolean");
			egl.atLine(this.eze$$fileName,76,2192,142, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					var ezert$$8 = 0;
					ezert$$8 = this.entries.getSize();
					n = ezert$$8;
					egl.setLocalFunctionVariable("n", n, "int");
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,77,2251,76, this);
							if ( !(egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").isControllerValid()) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,78,2304,15, this);
									result = false;
									egl.setLocalFunctionVariable("result", result, "boolean");
								}finally{egl.exitBlock();}
							}
			...
			egl.atLine(this.eze$$fileName,81,2338,15, this);
			$result = result;
			egl.setLocalFunctionVariable("BOOLEAN", $result, "boolean");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"validStateSetter": function( view, valid ) {
		...
		try { egl.enter("validStateSetter",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,85,2428,221, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,86,2487,29, this);
							...
							var msg = null;
							egl.addLocalFunctionVariable("msg", msg, "string?", "msg");
							egl.atLine(this.eze$$fileName,87,2535,34, this);
							var ezert$$10 = null;
							ezert$$10 = egl.checkNull(entry.controller, "entry.controller").getErrorMessage();
							egl.atLine(this.eze$$fileName,87,2521,49, this);
							msg = ezert$$10;
							egl.setLocalFunctionVariable("msg", msg, "string?");
							egl.atLine(this.eze$$fileName,88,2575,28, this);
							egl.checkNull(entry.errorLabel, "entry.errorLabel").setText((function(x){ return x != null ? ((x).toString()) : ""; })(msg));
							egl.atLine(this.eze$$fileName,89,2608,34, this);
			...
			egl.atLine(this.eze$$fileName,84,2365,290, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setValidState": function( entry, eze$$entry$func_, view, valid, eze$$caller ) {
		...
		try { egl.enter("setValidState",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("entry", entry, "com.ibm.egl.rui.mvc.FormField", "entry");
			egl.addLocalFunctionVariable("view", view, "egl.ui.rui.Widget", "view");
			egl.addLocalFunctionVariable("valid", valid, "boolean", "valid");
			egl.atLine(this.eze$$fileName,94,2738,187, this);
			if ( (egl.checkNull(entry.controller, "entry.controller").getView() == view) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,95,2777,141, this);
					if ( valid ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,96,2793,41, this);
							egl.checkNull(entry.nameLabel, "entry.nameLabel").setClass((function(x){ return x != null ? ((x).toString()) : ""; })(entry.labelClass));
						}finally{egl.exitBlock();}
					}
					else {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,98,2849,61, this);
			...
			egl.atLine(this.eze$$fileName,93,2661,270, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"eze$$getChildVariables": function() {
		...
		{name: "box", value : eze$$parent.box, type : "com.ibm.egl.rui.widgets.Box", jsName : "box"}
		];
	}
}
, 'div'

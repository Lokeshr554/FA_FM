...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.widgets.GridBehaviors');
else egl.eze$$userLibs = ['com.ibm.egl.rui.widgets.GridBehaviors'];
egl.defineRUILibrary( 'com.ibm.egl.rui.widgets', 'GridBehaviors',
	{
		'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/GridBehaviors.egl',
		...
		"whiteCells": function( grid, td, row, rowNumber, column ) {
			...
			try { egl.enter("whiteCells",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,14,422,46, this);
				td.setClass( (td.getClass() + " EglRuiGridCellColor2") );
				egl.atLine(this.eze$$fileName,13,318,156, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"grayCells": function( grid, td, row, rowNumber, column ) {
			...
			try { egl.enter("grayCells",this,arguments,eze$$updater);
				...
				egl.addLocalFunctionVariable("rowNumber", rowNumber, "int", "rowNumber");
				egl.addLocalFunctionVariable("column", column, "com.ibm.egl.rui.widgets.GridColumn", "column");
				egl.atLine(this.eze$$fileName,18,583,46, this);
				td.setClass( (td.getClass() + " EglRuiGridCellColor1") );
				egl.atLine(this.eze$$fileName,17,480,155, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"alternatingColor": function( grid, td, row, rowNumber, column ) {
			...
			try { egl.enter("alternatingColor",this,arguments,eze$$updater);
				...
				egl.addLocalFunctionVariable("rowNumber", rowNumber, "int", "rowNumber");
				egl.addLocalFunctionVariable("column", column, "com.ibm.egl.rui.widgets.GridColumn", "column");
				egl.atLine(this.eze$$fileName,22,751,81, this);
				if ( (egl.remainder(rowNumber, 2) == 1) ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,23,779,46, this);
						td.setClass( (td.getClass() + " EglRuiGridCellColor3") );
					}finally{egl.exitBlock();}
				}
				egl.atLine(this.eze$$fileName,21,641,197, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"tightCells": function( grid, td, row, rowNumber, column ) {
			...
			try { egl.enter("tightCells",this,arguments,eze$$updater);
				...
				egl.addLocalFunctionVariable("rowNumber", rowNumber, "int", "rowNumber");
				egl.addLocalFunctionVariable("column", column, "com.ibm.egl.rui.widgets.GridColumn", "column");
				egl.atLine(this.eze$$fileName,28,948,45, this);
				td.setClass( (td.getClass() + " EglRuiGridCellTight") );
				egl.atLine(this.eze$$fileName,27,844,155, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"getColumn": function( td ) {
			...
			try { egl.enter("getColumn",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,32,1062,22, this);
				tr = td.getParent();
				egl.setLocalFunctionVariable("tr", tr, "egl.ui.rui.Widget");
				var grid = null;
				egl.addLocalFunctionVariable("grid", grid, "com.ibm.egl.rui.widgets.Grid", "grid");
				egl.atLine(this.eze$$fileName,33,1088,29, this);
				{
				...
				egl.atLine(this.eze$$fileName,34,1121,29, this);
				cells = tr.getChildren();
				egl.setLocalFunctionVariable("cells", cells, "egl.ui.rui.Widget[]");
				egl.atLine(this.eze$$fileName,35,1154,114, this);
				{
					try{egl.enterBlock();
						var n = 0;
						...
						for ( ; (n <= cells.getSize()); n = (n + 1) )
						{
							egl.setLocalFunctionVariable("n", n, "int");
							try{egl.enterBlock();
								egl.atLine(this.eze$$fileName,36,1201,60, this);
								if ( (egl.checkNull(cells, "cells")[cells.checkIndex((n)-1)] == td) ) {
									try{egl.enterBlock();
										egl.atLine(this.eze$$fileName,37,1226,25, this);
										$result.eze$$assign(egl.checkNull(grid, "grid").columns[egl.checkNull(grid, "grid").columns.checkIndex((n)-1)]);
				...
				egl.atLine(this.eze$$fileName,40,1272,14, this);
				$result.setNull(true);
				egl.setLocalFunctionVariable("GridColumn", $result, "com.ibm.egl.rui.widgets.GridColumn");
				{ if (!egl.debugg) egl.leave(); return $result;}
			} finally {
		...
		"hasParent": function( widget, target ) {
			...
			try { egl.enter("hasParent",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,44,1373,79, this);
				while ( ((widget != null) && (widget != target)) ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,45,1422,23, this);
						widget = widget.getParent();
						egl.setLocalFunctionVariable("widget", widget, "egl.ui.rui.Widget");
					}finally{egl.exitBlock();}
					egl.atLine(this.eze$$fileName,44,1373,79, this);
				}
				egl.atLine(this.eze$$fileName,47,1456,26, this);

...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'Tree', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/Tree.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,355,30, this);
			...
			egl.atLine(this.eze$$fileName,14,388,39, this);
			this.nodeContainer = new egl.egl.ui.rui.Widget();
			egl.addEmbeddedWidget(this, "nodeContainer");
			
			egl.atLine(this.eze$$fileName,15,430,47, this);
			this.reverseTextDirectionThis = "";
			egl.atLine(this.eze$$fileName,16,480,42, this);
			this.textLayoutThis = "";
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,11,320,28, this);
			this.targetWidget = this.nodeContainer;
			egl.atLine(this.eze$$fileName,14,411,13, this);
	...
	"setChildren": function( children, eze$$children$func_, eze$$caller ) {
		...
		try { egl.enter("setChildren",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,19,584,187, this);
			if ( (this.getBackgroundColor() == "") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,20,615,149, this);
					throw (function () {
						var ezert$$2 = egl.createRuntimeException();
						egl.atLine(this.eze$$fileName,20,644,117, this);
			...
			egl.atLine(this.eze$$fileName,22,795,18, this);
			var ezert$$3 = 0;
			ezert$$3 = children.getSize();
			egl.atLine(this.eze$$fileName,22,775,39, this);
			childrenCount = ezert$$3;
			egl.setLocalFunctionVariable("childrenCount", childrenCount, "int");
			egl.atLine(this.eze$$fileName,23,818,31, this);
			this.nodeContainer.removeChildren();
			egl.atLine(this.eze$$fileName,24,853,335, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= childrenCount); n = (n + 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,25,898,28, this);
							{
							...
							egl.atLine(this.eze$$fileName,26,931,18, this);
							this.appendChild(node );
							egl.atLine(this.eze$$fileName,27,954,51, this);
							egl.checkNull(node, "node").markAsLast((n == childrenCount), this.getBackgroundColor() );
							egl.atLine(this.eze$$fileName,28,1014,167, this);
							if ( ((this.textLayoutThis == "Visual") || (this.reverseTextDirectionThis == "Yes")) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,29,1097,69, this);
			...
			egl.atLine(this.eze$$fileName,18,528,666, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"appendChild": function( child ) {
		...
		try { egl.enter("appendChild",this,arguments,eze$$updater);
			...
			var node = null;
			egl.addLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode", "node");
			egl.atLine(this.eze$$fileName,35,1256,22, this);
			{
				var eze$$src = child;
				if (!(eze$$src instanceof egl.com.ibm.egl.rui.widgets.TreeNode)) throw egl.createTypeCastException( 'CRRUI2017E', [ eze$$src, 'Widget', 'com.ibm.egl.rui.widgets.TreeNode' ], 'Widget', 'com.ibm.egl.rui.widgets.TreeNode' );
			}
			node = child;
			egl.setLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode");
			egl.atLine(this.eze$$fileName,36,1282,33, this);
			this.nodeContainer.appendChild(child );
			egl.atLine(this.eze$$fileName,37,1319,48, this);
			...
			egl.atLine(this.eze$$fileName,34,1201,172, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"removeChild": function( child ) {
		...
		try { egl.enter("removeChild",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("child", child, "egl.ui.rui.Widget", "child");
			egl.atLine(this.eze$$fileName,41,1435,33, this);
			this.nodeContainer.removeChild(child );
			egl.atLine(this.eze$$fileName,40,1380,94, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"removeChildren": function() {
		...
		try { egl.enter("removeChildren",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,45,1523,31, this);
			this.nodeContainer.removeChildren();
			egl.atLine(this.eze$$fileName,44,1480,80, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,49,1648,53, this);
			this.reverseTextDirectionThis = reverseTextDirection;
			egl.atLine(this.eze$$fileName,50,1705,23, this);
			this.setChildrenBiDiStyle();
			egl.atLine(this.eze$$fileName,48,1565,169, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,54,1809,39, this);
	...
	"setTextLayout": function( textLayout ) {
		...
		try { egl.enter("setTextLayout",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,58,1923,33, this);
			this.textLayoutThis = textLayout;
			egl.atLine(this.eze$$fileName,59,1960,23, this);
			this.setChildrenBiDiStyle();
			egl.atLine(this.eze$$fileName,57,1860,129, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTextLayout": function() {
		...
		try { egl.enter("getTextLayout",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,63,2054,29, this);
	...
	"setChildrenBiDiStyle": function() {
		...
		try { egl.enter("setChildrenBiDiStyle",this,arguments,eze$$updater);
			var children = null;
			egl.addLocalFunctionVariable("children", children, "egl.ui.rui.Widget[]", "!children");
			egl.atLine(this.eze$$fileName,67,2132,44, this);
			...
			egl.atLine(this.eze$$fileName,68,2183,42, this);
			if ( (children != null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,68,2203,18, this);
					var ezert$$4 = 0;
			...
			egl.atLine(this.eze$$fileName,68,2180,224, this);
			if ( eze_Cond_Temp_0 ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,69,2231,166, this);
					{
						try{egl.enterBlock();
							var i = 0;
							...
							for ( ; (i <= children.getSize()); i = (i + 1) )
							{
								...
								try{egl.enterBlock();
									var node = null;
									egl.addLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode", "node");
									egl.atLine(this.eze$$fileName,70,2282,28, this);
									{
									...
									egl.setLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode");
									egl.atLine(this.eze$$fileName,71,2319,69, this);
									egl.checkNull(node, "node").setBiDiStyle(this.textLayoutThis, this.reverseTextDirectionThis );
								}finally{egl.exitBlock();}
								egl.atLine(this.eze$$fileName,69,2231,166, this);
							}
			...
			egl.atLine(this.eze$$fileName,66,2096,316, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

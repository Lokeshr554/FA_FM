...
egl.defineClass('com.ibm.egl.rui.widgets', 'TreeTooltip', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,17,410,33, this);
			this.provider = null;
			
			egl.atLine(this.eze$$fileName,19,449,58, this);
			this.tooltip = new egl.com.ibm.egl.rui.widgets.Tooltip();
			egl.addEmbeddedWidget(this, "tooltip");
			
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,19,475,29, this);
			egl.checkNull(this.tooltip, "tooltip").provider = new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.TreeTooltip.prototype.getTooltipContents,"getTooltipContents");
	...
	"setTooltips": function( node ) {
		...
		try { egl.enter("setTooltips",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,22,555,21, this);
			egl.checkNull(this.tooltip, "tooltip").enable(node );
			egl.atLine(this.eze$$fileName,21,513,70, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTooltipContents": function( widget ) {
		...
		try { egl.enter("getTooltipContents",this,arguments,eze$$updater);
			...
			var node = null;
			egl.addLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode", "node");
			egl.atLine(this.eze$$fileName,26,648,23, this);
			...
			egl.atLine(this.eze$$fileName,27,685,14, this);
			var ezert$$1 = null;
			ezert$$1 = this.provider(node, function(eze$$inout$node) {
				node = eze$$inout$node;
				egl.setLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode");
			}, this );
			egl.setLocalFunctionVariable("node", node, "com.ibm.egl.rui.widgets.TreeNode");
			egl.atLine(this.eze$$fileName,27,675,25, this);
			tip = ezert$$1;
			egl.setLocalFunctionVariable("tip", tip, "com.ibm.egl.rui.widgets.Box");
			egl.atLine(this.eze$$fileName,28,704,12, this);
			$result = tip;
	...
	"eze$$getChildVariables": function() {
		...
		{name: "provider", value : eze$$parent.provider, type : "com.ibm.egl.rui.widgets.TreeTooltipTextProvider", jsName : "provider"},

...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.mvc.MVCLib');
else egl.eze$$userLibs = ['com.ibm.egl.rui.mvc.MVCLib'];
egl.defineRUILibrary( 'com.ibm.egl.rui.mvc', 'MVCLib',
	{
		...
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				...
				egl.atLine(this.eze$$fileName,13,328,44, this);
		...
		"getCurrentContext": function() {
			...
			try { egl.enter("getCurrentContext",this,arguments,eze$$updater);
				var $result = null;
				egl.atLine(this.eze$$fileName,16,429,26, this);
				$result = this.currentController;
				egl.setLocalFunctionVariable("Controller", $result, "com.ibm.egl.rui.mvc.Controller");
		...
		"setCurrentContext": function( acontroller ) {
			...
			try { egl.enter("setCurrentContext",this,arguments,eze$$updater);
				egl.addLocalFunctionVariable("acontroller", acontroller, "com.ibm.egl.rui.mvc.Controller", "acontroller");
				egl.atLine(this.eze$$fileName,20,524,37, this);
				this.currentController = acontroller;
				egl.atLine(this.eze$$fileName,19,467,100, this);
				{ if (!egl.debugg) egl.leave(); }
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"eze$$getChildVariables": function() {
			...
			{name: "currentController", value : eze$$parent.currentController, type : "com.ibm.egl.rui.mvc.Controller", jsName : "currentController"}
			];
		}
	}
);

...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'PasswordTextField', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/PasswordTextField.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,40,1372,48, this);
			this.maxLength = 0;
			egl.atLine(this.eze$$fileName,41,1423,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,42,1511,94, this);
			this.readOnly = false;
			egl.atLine(this.eze$$fileName,43,1608,22, this);
			this.error = false;
			egl.atLine(this.eze$$fileName,45,1636,37, this);
			this.savedEnableSelection = false;
			egl.atLine(this.eze$$fileName,46,1676,36, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,49,1737,34, this);
			this.getOnFocusGained().appendElement( new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.PasswordTextField.prototype.enableSelection,"enableSelection") );
			egl.atLine(this.eze$$fileName,50,1775,33, this);
			this.getOnFocusLost().appendElement( new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.PasswordTextField.prototype.disableSelection,"disableSelection") );
			egl.atLine(this.eze$$fileName,48,1717,97, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enableSelection": function( e ) {
		...
		try { egl.enter("enableSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,54,1891,32, this);
			var ezert$$1 = false;
			ezert$$1 = egl.egl.ui.rui.RUILib['$inst'].getTextSelectionEnabled();
			egl.atLine(this.eze$$fileName,54,1868,56, this);
			this.savedEnableSelection = ezert$$1;
			egl.atLine(this.eze$$fileName,55,1928,37, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(true );
			egl.atLine(this.eze$$fileName,53,1820,151, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"disableSelection": function( e ) {
		...
		try { egl.enter("disableSelection",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,59,2026,53, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(this.savedEnableSelection );
			egl.atLine(this.eze$$fileName,58,1977,108, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReadOnly": function() {
		...
		try { egl.enter("getReadOnly",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,63,2143,17, this);
	...
	"setReadOnly": function( ro ) {
		...
		try { egl.enter("setReadOnly",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,67,2219,14, this);
			this.readOnly = ro;
			egl.atLine(this.eze$$fileName,68,2237,313, this);
			if ( this.readOnly ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,69,2254,33, this);
					this.setAttribute("readOnly", {eze$$value : "true", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,70,2292,39, this);
					this.savedBackgroundColor = this.getBackgroundColor();
					egl.atLine(this.eze$$fileName,71,2336,23, this);
					this.setBackgroundColor(String('',null));
					egl.atLine(this.eze$$fileName,72,2364,47, this);
					this.setClass("EglRuiPasswordTextFieldReadOnly");
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,74,2424,28, this);
					this.removeAttribute("readOnly" );
					egl.atLine(this.eze$$fileName,75,2460,39, this);
					this.setBackgroundColor(this.savedBackgroundColor);
					egl.atLine(this.eze$$fileName,76,2504,39, this);
					this.setClass("EglRuiPasswordTextField");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,66,2172,384, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,81,2605,28, this);
			this.setAttribute("value", {eze$$value : text, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,80,2561,78, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,85,2692,43, this);
			var ezert$$3 = null;
			ezert$$3 = ezert$$2;
			$result = egl.convertAnyToString(ezert$$3,false);
	...
	"getWidgetOrientation": function() {
		...
		try { egl.enter("getWidgetOrientation",this,arguments,eze$$updater);
			var $result = "";
			var ezert$$4 = null;
			ezert$$4 = this.getAttribute("dir" );
			egl.atLine(this.eze$$fileName,89,2813,41, this);
			var ezert$$5 = null;
			ezert$$5 = ezert$$4;
			$result = egl.convertAnyToString(ezert$$5,false);
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
			if (!egl.debugg){
	...
	"setWidgetOrientation": function( widgetOrientation ) {
		...
		try { egl.enter("setWidgetOrientation",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,93,2942,116, this);
			if ( (widgetOrientation == "RTL") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,94,2978,27, this);
					this.setAttribute("dir", {eze$$value : "rtl", eze$$signature : "S;"} );
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,96,3018,29, this);
					this.setAttribute("align", {eze$$value : "ltr", eze$$signature : "S;"} );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,92,2866,200, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getMaxLength": function() {
		...
		try { egl.enter("getMaxLength",this,arguments,eze$$updater);
			var $result = 0;
			var ezert$$6 = null;
			ezert$$6 = this.getAttribute("maxLength" );
			egl.atLine(this.eze$$fileName,101,3122,42, this);
			var ezert$$7 = null;
			ezert$$7 = ezert$$6;
			$result = egl.convertAnyToInt(ezert$$7,false);
	...
	"setMaxLength": function( maxLength ) {
		...
		try { egl.enter("setMaxLength",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("maxLength", maxLength, "int", "maxLength");
			egl.atLine(this.eze$$fileName,105,3227,47, this);
			this.setAttribute("maxLength", {eze$$value : (maxLength).toString(), eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,104,3176,104, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"eze$$getChildVariables": function() {
		...
		{name: "maxLength", value : function(){try{return eze$$parent.getMaxLength();}catch(e){return null;}}(), type : "int", jsName : "maxLength", getter : "getMaxLength", setter : "setMaxLength"},

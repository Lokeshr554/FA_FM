...
egl.defineRUIWidget('com.ibm.egl.rui.mvc', 'FormManager', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/mvc/FormManager.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,16,399,84, this);
	...
	"setEntries": function( entries ) {
		...
		try { egl.enter("setEntries",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,19,536,23, this);
			this.entries = entries;
			egl.atLine(this.eze$$fileName,20,563,250, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= entries.getSize()); n = (n + 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,21,612,56, this);
							...
							egl.atLine(this.eze$$fileName,22,673,133, this);
							if ( (egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").validStateSetter == null) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,23,735,63, this);
			...
			egl.atLine(this.eze$$fileName,18,489,330, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getEntries": function() {
		...
		try { egl.enter("getEntries",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,29,871,17, this);
			$result = this.entries;
	...
	"commit": function() {
		...
		try { egl.enter("commit",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,34,926,273, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,35,985,31, this);
							...
							egl.atLine(this.eze$$fileName,36,1034,39, this);
							var ezert$$4 = null;
			...
			egl.atLine(this.eze$$fileName,33,905,300, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"publish": function() {
		...
		try { egl.enter("publish",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,44,1233,98, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,45,1292,32, this);
			...
			egl.atLine(this.eze$$fileName,43,1211,129, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"isValid": function() {
		...
		try { egl.enter("isValid",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,50,1385,22, this);
			result = true;
			egl.setLocalFunctionVariable("result", result, "boolean");
			egl.atLine(this.eze$$fileName,51,1411,132, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
			...
			egl.atLine(this.eze$$fileName,56,1547,15, this);
			$result = result;
	...
	"isFormValid": function() {
		...
		try { egl.enter("isFormValid",this,arguments,eze$$updater);
			...
			var result = false;
			egl.addLocalFunctionVariable("result", result, "boolean", "result");
			egl.atLine(this.eze$$fileName,60,1617,22, this);
			result = true;
			egl.setLocalFunctionVariable("result", result, "boolean");
			egl.atLine(this.eze$$fileName,61,1643,142, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					for ( ; (n >= 1); n = (n - 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,62,1702,76, this);
							if ( !(egl.checkNull(egl.checkNull(this.entries, "entries")[this.entries.checkIndex((n)-1)].controller, "entries[n].controller").isControllerValid()) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,63,1755,15, this);
									result = false;
									egl.setLocalFunctionVariable("result", result, "boolean");
								}finally{egl.exitBlock();}
							}
			...
			egl.atLine(this.eze$$fileName,66,1789,15, this);
			$result = result;
			egl.setLocalFunctionVariable("BOOLEAN", $result, "boolean");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"validStateSetter": function( view, valid ) {
		...
		try { egl.enter("validStateSetter",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,70,1887,686, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					...
					Lezert$$1: for ( ; (n >= 1); n = (n - 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,71,1954,29, this);
							...
							egl.atLine(this.eze$$fileName,72,1997,563, this);
							if ( (egl.checkNull(entry.controller, "entry.controller").getView() == view) ) {
								try{egl.enterBlock();
									var msg = null;
									egl.addLocalFunctionVariable("msg", msg, "string?", "msg");
									egl.atLine(this.eze$$fileName,73,2062,34, this);
									var ezert$$9 = null;
									ezert$$9 = egl.checkNull(entry.controller, "entry.controller").getErrorMessage();
									egl.atLine(this.eze$$fileName,73,2048,49, this);
									msg = ezert$$9;
									egl.setLocalFunctionVariable("msg", msg, "string?");
									egl.atLine(this.eze$$fileName,74,2115,99, this);
									if ( (entry.errorLabel != null) ) {
										try{egl.enterBlock();
											egl.atLine(this.eze$$fileName,75,2165,28, this);
											egl.checkNull(entry.errorLabel, "entry.errorLabel").setText((function(x){ return x != null ? ((x).toString()) : ""; })(msg));
										}finally{egl.exitBlock();}
									}
									egl.atLine(this.eze$$fileName,77,2232,284, this);
									if ( (entry.nameLabel != null) ) {
										try{egl.enterBlock();
											egl.atLine(this.eze$$fileName,78,2281,214, this);
											if ( valid ) {
												try{egl.enterBlock();
													egl.atLine(this.eze$$fileName,79,2316,41, this);
													egl.checkNull(entry.nameLabel, "entry.nameLabel").setClass((function(x){ return x != null ? ((x).toString()) : ""; })(entry.labelClass));
												}finally{egl.exitBlock();}
											}
											else {
												try{egl.enterBlock();
													egl.atLine(this.eze$$fileName,81,2409,61, this);
									...
									egl.atLine(this.eze$$fileName,84,2534,9, this);
									break Lezert$$1;
								}finally{egl.exitBlock();}
							}
						}finally{egl.exitBlock();}
			...
			egl.atLine(this.eze$$fileName,69,1818,764, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"validate": function() {
		...
		try { egl.enter("validate",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,90,2636,166, this);
			{
				try{egl.enterBlock();
					var n = 0;
					egl.addLocalFunctionVariable("n", n, "int", "n");
					var ezert$$10 = 0;
					ezert$$10 = this.entries.getSize();
					n = ezert$$10;
					egl.setLocalFunctionVariable("n", n, "int");
					for ( ; (n >= 1); n = (n - 1) )
					{
			...
			egl.atLine(this.eze$$fileName,95,2812,13, this);
			$result = true;
			egl.setLocalFunctionVariable("BOOLEAN", $result, "boolean");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {

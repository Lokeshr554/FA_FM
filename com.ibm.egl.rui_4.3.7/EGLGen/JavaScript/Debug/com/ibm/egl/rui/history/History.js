...
egl.defineRUIWidget('com.ibm.egl.rui.history', 'History', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/history/History.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,24,550,21, this);
			this.frame = null;
			egl.addEmbeddedWidget(this, "frame");
			
			egl.atLine(this.eze$$fileName,25,577,40, this);
			this.listeners = null;
			
			egl.atLine(this.eze$$fileName,26,623,51, this);
			this.checkURLJob = new egl.egl.javascript.Job();
			
			egl.atLine(this.eze$$fileName,27,680,31, this);
			this.currentLocation = "";
			egl.atLine(this.eze$$fileName,28,717,32, this);
			...
			egl.atLine(this.eze$$fileName,26,649,22, this);
			...
			egl.atLine(this.eze$$fileName,29,755,76, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,32,874,321, this);
			if ( !(this.browser.inVisualEditorDesignMode()) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,33,926,14, this);
					var ezert$$1 = false;
					ezert$$1 = this.browser.isIE();
					egl.atLine(this.eze$$fileName,33,922,231, this);
					if ( ezert$$1 ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,34,950,101, this);
							this.frame = (function () {
								var ezert$$2 = new egl.egl.ui.rui.Widget();
								egl.atLine(this.eze$$fileName,34,971,16, this);
								ezert$$2.setTagName( "iframe" );
								egl.atLine(this.eze$$fileName,34,989,19, this);
								ezert$$2.setVisibility( "hidden" );
								egl.atLine(this.eze$$fileName,34,1010,19, this);
								ezert$$2.setPosition( "absolute" );
								egl.atLine(this.eze$$fileName,34,1031,7, this);
								ezert$$2.setWidth( (0).toString() );
								egl.atLine(this.eze$$fileName,34,1040,8, this);
								ezert$$2.setHeight( (0).toString() );
								return ezert$$2;
							}).call(this);
							egl.atLine(this.eze$$fileName,35,1060,33, this);
							this.document.body.appendChild(this.frame );
							egl.atLine(this.eze$$fileName,36,1102,40, this);
							this.frame.setAttribute("src", ("com/ibm/egl/rui/history/history.html?history=" + "empty") );
						}finally{egl.exitBlock();}
					}
					egl.atLine(this.eze$$fileName,38,1161,24, this);
					this.checkURLJob.repeat(100 );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,31,843,361, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"goBack": function() {
		...
		try { egl.enter("goBack",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,43,1241,17, this);
			this.browser.goBack();
			egl.atLine(this.eze$$fileName,42,1216,51, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"goForward": function() {
		...
		try { egl.enter("goForward",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,47,1306,20, this);
			this.browser.goForward();
			egl.atLine(this.eze$$fileName,46,1279,56, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"addListener": function( listener, eze$$listener$func_, eze$$caller ) {
		...
		try { egl.enter("addListener",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,51,1399,81, this);
			if ( !(this.browser.inVisualEditorDesignMode()) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,52,1447,23, this);
					this.listeners.appendElement( listener );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,50,1347,142, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"addToHistory": function( newLocation ) {
		...
		try { egl.enter("addToHistory",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,57,1553,408, this);
			if ( !(this.browser.inVisualEditorDesignMode()) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,58,1601,195, this);
					if ( (newLocation == "") ) {
						try{egl.enterBlock();
							var messageValue = "";
							egl.addLocalFunctionVariable("messageValue", messageValue, "string", "messageValue");
							egl.atLine(this.eze$$fileName,59,1654,46, this);
							var ezert$$3 = null;
							ezert$$3 = egl.getRuntimeMessage( "CRRUI2004E", [ newLocation ] );
							egl.atLine(this.eze$$fileName,59,1632,69, this);
							messageValue = (function(x){ return x != null ? ((x).toString()) : ""; })(ezert$$3);
							egl.setLocalFunctionVariable("messageValue", messageValue, "string");
							egl.atLine(this.eze$$fileName,60,1707,78, this);
							throw (function () {
								var ezert$$4 = egl.createRuntimeException();
								egl.atLine(this.eze$$fileName,60,1735,22, this);
								egl.checkNull(ezert$$4, "ezert$$4").message = messageValue;
								egl.atLine(this.eze$$fileName,60,1759,24, this);
								egl.checkNull(ezert$$4, "ezert$$4").messageID = "CRRUI2004E";
								return ezert$$4;
							}).call(this);
						}finally{egl.exitBlock();}
					}
					egl.atLine(this.eze$$fileName,62,1804,37, this);
					this.browser.setLocationHash(newLocation );
					egl.atLine(this.eze$$fileName,63,1849,11, this);
					this.checkURL();
					egl.atLine(this.eze$$fileName,64,1872,14, this);
					var ezert$$5 = false;
					ezert$$5 = this.browser.isIE();
					egl.atLine(this.eze$$fileName,64,1868,83, this);
					if ( ezert$$5 ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,65,1896,44, this);
							this.frame.setAttribute("src", ("com/ibm/egl/rui/history/history.html?history=" + newLocation) );
						}finally{egl.exitBlock();}
					}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,56,1501,469, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"tellListeners": function() {
		...
		try { egl.enter("tellListeners",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,71,2021,128, this);
			{
				try{egl.enterBlock();
					var n = 0;
					...
					for ( ; (n <= this.listeners.getSize()); n = (n + 1) )
					{
						egl.setLocalFunctionVariable("n", n, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,72,2088,49, this);
							var ezert$$6 = "";
							ezert$$6 = egl.egl.core.$ServiceLib.convertFromURLEncoded( this.currentLocation );
							egl.atLine(this.eze$$fileName,72,2075,64, this);
			...
			egl.atLine(this.eze$$fileName,70,1982,176, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"checkURL": function() {
		...
		try { egl.enter("checkURL",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,77,2205,14, this);
			var ezert$$7 = false;
			ezert$$7 = this.browser.isIE();
			egl.atLine(this.eze$$fileName,77,2201,537, this);
			if ( ezert$$7 ) {
				try{egl.enterBlock();
					var location = "";
					egl.addLocalFunctionVariable("location", location, "string", "location");
					egl.atLine(this.eze$$fileName,78,2247,26, this);
					var ezert$$8 = "";
					ezert$$8 = this.browser.getFrameSrc(this.frame );
					egl.atLine(this.eze$$fileName,78,2229,45, this);
					location = ezert$$8;
					egl.setLocalFunctionVariable("location", location, "string");
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					egl.atLine(this.eze$$fileName,79,2294,29, this);
					var ezert$$9 = 0;
					ezert$$9 = egl.egl.core.$StrLib.indexOf( location, ("="));
					egl.setLocalFunctionVariable("location", location, "string");
					egl.atLine(this.eze$$fileName,79,2282,42, this);
					index = ezert$$9;
					egl.setLocalFunctionVariable("index", index, "int");
					egl.atLine(this.eze$$fileName,80,2362,29, this);
					var ezert$$10 = 0;
					ezert$$10 = egl.egl.core.$StrLib.textLen( location);
					egl.atLine(this.eze$$fileName,80,2332,61, this);
					location = location.substring( (index + 1)-1,ezert$$10);
					egl.setLocalFunctionVariable("location", location, "string");
					egl.atLine(this.eze$$fileName,81,2401,167, this);
					if ( ((location != null) && (location != this.currentLocation)) ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,82,2462,27, this);
							this.currentLocation = location;
							egl.atLine(this.eze$$fileName,83,2498,34, this);
							this.browser.setLocationHash(location );
							egl.atLine(this.eze$$fileName,84,2541,16, this);
							this.tellListeners();
						}finally{egl.exitBlock();}
					}
				}finally{egl.exitBlock();}
				...
				try{egl.enterBlock();
					...
					egl.atLine(this.eze$$fileName,87,2598,25, this);
					var ezert$$11 = "";
					ezert$$11 = this.browser.getLocationHash();
					egl.atLine(this.eze$$fileName,87,2584,40, this);
					hash = ezert$$11;
					egl.setLocalFunctionVariable("hash", hash, "string");
					egl.atLine(this.eze$$fileName,88,2632,96, this);
					if ( (hash != this.currentLocation) ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,89,2669,23, this);
							this.currentLocation = hash;
							egl.atLine(this.eze$$fileName,90,2701,16, this);
							this.tellListeners();
						}finally{egl.exitBlock();}
					}
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,76,2170,577, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"keepUserOnPage": function( onBeforeUnloadMessageFunction, eze$$onBeforeUnloadMessageFunction$func_, eze$$caller ) {
		...
		try { egl.enter("keepUserOnPage",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,96,2850,115, this);
			if ( !(this.browser.inVisualEditorDesignMode()) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,97,2898,57, this);
			...
			egl.atLine(this.eze$$fileName,95,2759,215, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

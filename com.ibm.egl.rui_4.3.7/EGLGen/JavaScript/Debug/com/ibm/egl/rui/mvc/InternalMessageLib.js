...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.mvc.InternalMessageLib');
else egl.eze$$userLibs = ['com.ibm.egl.rui.mvc.InternalMessageLib'];
egl.defineRUILibrary( 'com.ibm.egl.rui.mvc', 'InternalMessageLib',
	{
		'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/mvc/InternalMessageLib.egl',
		...
		"getRuntimeErrorMessage": function( msgKey, defaultMsgId, inserts ) {
			...
			try { egl.enter("getRuntimeErrorMessage",this,arguments,eze$$updater);
				var $result = "";
				egl.addLocalFunctionVariable("msgKey", msgKey, "string", "msgKey");
				egl.addLocalFunctionVariable("defaultMsgId", defaultMsgId, "string", "defaultMsgId");
				...
				egl.atLine(this.eze$$fileName,16,512,149, this);
				if ( (msgKey == "") ) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,17,557,40, this);
						var ezert$$1 = null;
						ezert$$1 = egl.getRuntimeMessage( defaultMsgId, inserts );
						egl.atLine(this.eze$$fileName,17,542,56, this);
						messageValue = (function(x){ return x != null ? ((x).toString()) : ""; })(ezert$$1);
						egl.setLocalFunctionVariable("messageValue", messageValue, "string");
					}finally{egl.exitBlock();}
				}
				else {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,19,626,22, this);
						messageValue = msgKey;
						egl.setLocalFunctionVariable("messageValue", messageValue, "string");
					}finally{egl.exitBlock();}
				}
				egl.atLine(this.eze$$fileName,21,671,21, this);
				$result = messageValue;

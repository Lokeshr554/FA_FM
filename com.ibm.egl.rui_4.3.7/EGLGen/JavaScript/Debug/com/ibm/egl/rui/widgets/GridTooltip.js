...
egl.defineClass('com.ibm.egl.rui.widgets', 'GridTooltip', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/GridTooltip.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,17,441,33, this);
			this.provider = null;
			
			egl.atLine(this.eze$$fileName,18,477,10, this);
			this.grid = null;
			egl.addEmbeddedWidget(this, "grid");
			
			egl.atLine(this.eze$$fileName,20,493,58, this);
			...
			egl.atLine(this.eze$$fileName,20,519,29, this);
	...
	"setTooltips": function( grid, td, row, rowNumber, column ) {
		...
		try { egl.enter("setTooltips",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,23,661,19, this);
			egl.checkNull(this.tooltip, "tooltip").enable(td );
			egl.atLine(this.eze$$fileName,24,684,40, this);
			td.setAttribute("rowNumber", rowNumber );
			egl.atLine(this.eze$$fileName,25,729,17, this);
			this.grid = grid;
			egl.atLine(this.eze$$fileName,22,557,195, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTooltipContents": function( widget ) {
		...
		try { egl.enter("getTooltipContents",this,arguments,eze$$updater);
			...
			var td = null;
			egl.addLocalFunctionVariable("td", td, "egl.ui.rui.Widget", "td");
			egl.atLine(this.eze$$fileName,29,817,19, this);
			...
			var row = null;
			egl.addLocalFunctionVariable("row", row, "any", "row");
			egl.atLine(this.eze$$fileName,30,860,28, this);
			var ezert$$1 = null;
			ezert$$1 = td.getAttribute("rowNumber" );
			egl.atLine(this.eze$$fileName,30,840,50, this);
			...
			egl.addLocalFunctionVariable("column", column, "com.ibm.egl.rui.widgets.GridColumn", "column");
			egl.atLine(this.eze$$fileName,31,914,27, this);
			...
			egl.atLine(this.eze$$fileName,31,894,48, this);
			...
			egl.atLine(this.eze$$fileName,32,956,30, this);
			var ezert$$3 = null;
			ezert$$3 = this.provider(row, column.name, td );
			egl.atLine(this.eze$$fileName,32,946,41, this);
			tip = ezert$$3;
			egl.setLocalFunctionVariable("tip", tip, "com.ibm.egl.rui.widgets.Box");
			egl.atLine(this.eze$$fileName,33,991,12, this);
			$result = tip;

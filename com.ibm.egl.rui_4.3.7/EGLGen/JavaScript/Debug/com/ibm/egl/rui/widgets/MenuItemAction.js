...
egl.defineClass('com.ibm.egl.rui.widgets', 'MenuItemAction', {
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,13,339,28, this);
			this.theAction = null;
			
			egl.atLine(this.eze$$fileName,14,370,12, this);
			this.theItem = null;
			egl.atLine(this.eze$$fileName,15,385,19, this);
	...
	"addActionTo": function( widget ) {
		...
		try { egl.enter("addActionTo",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("widget", widget, "any", "widget");
			var newwidget = null;
			egl.addLocalFunctionVariable("newwidget", newwidget, "egl.ui.rui.Widget", "newwidget");
			egl.atLine(this.eze$$fileName,18,449,26, this);
			newwidget = egl.convertAnyToRefType(widget,"Tegl/ui/rui/widget;",egl.egl.ui.rui.Widget);
			egl.setLocalFunctionVariable("newwidget", newwidget, "egl.ui.rui.Widget");
			egl.atLine(this.eze$$fileName,19,479,32, this);
			newwidget.getOnClick().appendElement( new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.MenuItemAction.prototype.runAction,"runAction") );
			egl.atLine(this.eze$$fileName,17,410,107, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"eze$$getChildVariables": function() {
		...
		{name: "theAction", value : eze$$parent.theAction, type : "com.ibm.egl.rui.widgets.MenuItemSelection", jsName : "theAction"},
		{name: "theItem", value : eze$$parent.theItem, type : "any", jsName : "theItem"},
		{name: "theParentMenu", value : eze$$parent.theParentMenu, type : "com.ibm.egl.rui.widgets.Menu", jsName : "theParentMenu"}
		];
	}
}
);

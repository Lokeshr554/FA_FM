...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'HTML', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/HTML.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,21,594,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,22,682,82, this);
			this.src = "";
			egl.atLine(this.eze$$fileName,24,770,26, this);
			this.contextURL = "";
			egl.atLine(this.eze$$fileName,25,799,42, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,28,867,36, this);
			...
			egl.atLine(this.eze$$fileName,29,920,30, this);
			var ezert$$1 = 0;
			ezert$$1 = egl.egl.core.$StrLib.indexOf( location, ("//"));
			egl.setLocalFunctionVariable("location", location, "string");
			egl.atLine(this.eze$$fileName,29,907,45, this);
			index0 = ezert$$1;
			egl.setLocalFunctionVariable("index0", index0, "int");
			egl.atLine(this.eze$$fileName,30,965,41, this);
			var ezert$$2 = 0;
			ezert$$2 = egl.egl.core.$StrLib.indexOf( location, ("/"), (index0 + 2));
			egl.setLocalFunctionVariable("location", location, "string");
			egl.atLine(this.eze$$fileName,30,956,51, this);
			index0 = ezert$$2;
			egl.setLocalFunctionVariable("index0", index0, "int");
			var index1 = 0;
			egl.addLocalFunctionVariable("index1", index1, "int", "index1");
			egl.atLine(this.eze$$fileName,31,1024,41, this);
			var ezert$$3 = 0;
			ezert$$3 = egl.egl.core.$StrLib.indexOf( location, ("/"), (index0 + 1));
			egl.setLocalFunctionVariable("location", location, "string");
			egl.atLine(this.eze$$fileName,31,1011,55, this);
			index1 = ezert$$3;
			egl.setLocalFunctionVariable("index1", index1, "int");
			egl.atLine(this.eze$$fileName,32,1070,44, this);
			if ( (index1 != 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,33,1091,16, this);
					index0 = index1;
					egl.setLocalFunctionVariable("index0", index0, "int");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,35,1121,32, this);
			this.contextURL = location.substring( 1-1,index0);
			egl.atLine(this.eze$$fileName,27,847,312, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,39,1201,17, this);
			this.text = text;
			egl.atLine(this.eze$$fileName,40,1222,17, this);
			this.setInnerHTML(text);
			egl.atLine(this.eze$$fileName,38,1165,80, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,44,1290,19, this);
			$result = this.text;
	...
	"setSrc": function( src ) {
		...
		try { egl.enter("setSrc",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,49,1396,26, this);
			var ezert$$4 = null;
			ezert$$4 = egl.egl.core.$StrLib.lowerCase( (src.substring( 1-1,4)));
			egl.atLine(this.eze$$fileName,49,1392,206, this);
			if ( (egl.nullableCompare(ezert$$4,"http", 0) != 0) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,50,1447,66, this);
				...
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,52,1538,53, this);
					var ezert$$7_in = src;
			...
			egl.atLine(this.eze$$fileName,54,1602,15, this);
			this.src = src;
			egl.atLine(this.eze$$fileName,47,1320,303, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSrc": function() {
		...
		try { egl.enter("getSrc",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,58,1667,13, this);
			$result = this.src;
			egl.setLocalFunctionVariable("STRING", $result, "string");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"getWidgetOrientation": function() {
		...
		try { egl.enter("getWidgetOrientation",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,62,1757,36, this);
	...
	"setWidgetOrientation": function( widgetOrientation ) {
		...
		try { egl.enter("setWidgetOrientation",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,66,1883,47, this);
			this.widgetOrientationThis = widgetOrientation;
			egl.atLine(this.eze$$fileName,67,1935,215, this);
			if ( (widgetOrientation == "RTL") ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,68,1970,34, this);
					this.setStyle("text-align: right;");
					var ezert$$9 = "";
					ezert$$9 = this.getTextLayout();
					egl.atLine(this.eze$$fileName,69,2009,82, this);
					if ( (ezert$$9 != "Visual") ) {
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,70,2051,32, this);
				...
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,73,2108,33, this);
					this.setStyle("text-align: left;");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,65,1807,349, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

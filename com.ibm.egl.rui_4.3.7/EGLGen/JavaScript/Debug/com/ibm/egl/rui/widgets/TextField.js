...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'TextField', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/TextField.egl',
	'eze$$runtimePropertiesFile': 'com/ibm/egl/rui/widgets/TextField',
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,62,2221,48, this);
			this.maxLength = 0;
			egl.atLine(this.eze$$fileName,63,2272,85, this);
			this.text = "";
			egl.atLine(this.eze$$fileName,64,2360,94, this);
			this.readOnly = false;
			egl.atLine(this.eze$$fileName,65,2457,22, this);
			this.error = false;
			egl.atLine(this.eze$$fileName,67,2485,37, this);
			this.savedEnableSelection = false;
			egl.atLine(this.eze$$fileName,68,2525,36, this);
	...
	"start": function() {
		...
		try { egl.enter("start",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,71,2586,34, this);
			this.getOnFocusGained().appendElement( new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.TextField.prototype.enableSelection,"enableSelection") );
			egl.atLine(this.eze$$fileName,72,2624,33, this);
			this.getOnFocusLost().appendElement( new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.TextField.prototype.disableSelection,"disableSelection") );
			egl.atLine(this.eze$$fileName,70,2566,97, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"enableSelection": function( e ) {
		...
		try { egl.enter("enableSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,76,2740,32, this);
			var ezert$$1 = false;
			ezert$$1 = egl.egl.ui.rui.RUILib['$inst'].getTextSelectionEnabled();
			egl.atLine(this.eze$$fileName,76,2717,56, this);
			this.savedEnableSelection = ezert$$1;
			egl.atLine(this.eze$$fileName,77,2777,37, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(true );
			egl.atLine(this.eze$$fileName,75,2669,151, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"disableSelection": function( e ) {
		...
		try { egl.enter("disableSelection",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("e", e, "egl.ui.rui.Event", "e");
			egl.atLine(this.eze$$fileName,81,2875,53, this);
			egl.egl.ui.rui.RUILib['$inst'].setTextSelectionEnabled(this.savedEnableSelection );
			egl.atLine(this.eze$$fileName,80,2826,108, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReadOnly": function() {
		...
		try { egl.enter("getReadOnly",this,arguments,eze$$updater);
			var $result = false;
			egl.atLine(this.eze$$fileName,85,2992,17, this);
	...
	"setReadOnly": function( ro ) {
		...
		try { egl.enter("setReadOnly",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,89,3068,14, this);
			this.readOnly = ro;
			egl.atLine(this.eze$$fileName,90,3086,284, this);
			if ( this.readOnly ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,91,3103,33, this);
					this.setAttribute("readOnly", {eze$$value : "true", eze$$signature : "S;"} );
					egl.atLine(this.eze$$fileName,92,3141,39, this);
					this.savedBackgroundColor = this.getBackgroundColor();
					egl.atLine(this.eze$$fileName,93,3185,23, this);
					this.setBackgroundColor(String('',null));
					egl.atLine(this.eze$$fileName,94,3213,34, this);
					this.setClass("EglRuiTextFieldReadOnly");
				}finally{egl.exitBlock();}
			}
			else {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,96,3260,28, this);
					this.removeAttribute("readOnly" );
					egl.atLine(this.eze$$fileName,97,3293,39, this);
					this.setBackgroundColor(this.savedBackgroundColor);
					egl.atLine(this.eze$$fileName,98,3337,26, this);
					this.setClass("EglRuiTextField");
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,88,3021,355, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setText": function( text ) {
		...
		try { egl.enter("setText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,103,3425,28, this);
			this.setAttribute("value", {eze$$value : text, eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,102,3381,78, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getText": function() {
		...
		try { egl.enter("getText",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,107,3512,43, this);
			var ezert$$3 = null;
			ezert$$3 = ezert$$2;
	...
	"getMaxLength": function() {
		...
		try { egl.enter("getMaxLength",this,arguments,eze$$updater);
			var $result = 0;
			var ezert$$4 = null;
			ezert$$4 = this.getAttribute("maxLength" );
			egl.atLine(this.eze$$fileName,111,3616,42, this);
			var ezert$$5 = null;
			ezert$$5 = ezert$$4;
			$result = egl.convertAnyToInt(ezert$$5,false);
	...
	"setMaxLength": function( maxLength ) {
		...
		try { egl.enter("setMaxLength",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,115,3721,47, this);
			this.setAttribute("maxLength", {eze$$value : (maxLength).toString(), eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,114,3670,104, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

...
// No APARs installed.
if (egl.eze$$userLibs) egl.eze$$userLibs.push('com.ibm.egl.rui.widgets.BoxLib');
else egl.eze$$userLibs = ['com.ibm.egl.rui.widgets.BoxLib'];
egl.defineRUILibrary( 'com.ibm.egl.rui.widgets', 'BoxLib',
	{
		'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/BoxLib.egl',
		'eze$$runtimePropertiesFile': 'com/ibm/egl/rui/widgets/BoxLib',
		"constructor" : function()
		{
			...
			try { egl.enter("<init>",this,arguments,eze$$updater);
				if(egl.com.ibm.egl.rui.widgets.BoxLib['$inst']){
					if (!egl.debugg) egl.leave();
					return egl.com.ibm.egl.rui.widgets.BoxLib['$inst'];
				}
				egl.com.ibm.egl.rui.widgets.BoxLib['$inst']=this;
				this.jsrt$SysVar= new egl.egl.core.SysVar();
				egl.atLine(this.eze$$fileName,14,351,26, this);
				this.ALIGN_RIGHT = 2;
				egl.atLine(this.eze$$fileName,15,380,25, this);
				this.ALIGN_LEFT = 0;
				egl.atLine(this.eze$$fileName,16,409,27, this);
				this.ALIGN_CENTER = 1;
				if (!egl.debugg) egl.leave();
			} finally {
				if (!egl.debugg){

...
egl.defineRUIWidget('com.ibm.egl.rui.widgets', 'ListMulti', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/ListMulti.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,19,567,93, this);
			this.values = (function(){ var ezert$$1= []; ezert$$1.setType( "S;" );// no max size set for this array
			return ezert$$1;})();
			
			egl.atLine(this.eze$$fileName,20,663,99, this);
			this.selection = (function(){ var ezert$$2= []; ezert$$2.setType( "I;" );// no max size set for this array
			return ezert$$2;})();
			
			egl.atLine(this.eze$$fileName,25,858,80, this);
			this.size = 0;
			egl.atLine(this.eze$$fileName,27,944,26, this);
			...
			egl.atLine(this.eze$$fileName,28,973,32, this);
			this.sizeSet = false;
			egl.atLine(this.eze$$fileName,29,1008,47, this);
			this.reverseTextDirectionThis = "";
			egl.atLine(this.eze$$fileName,30,1058,42, this);
			this.textLayoutThis = "";
			egl.atLine(this.eze$$fileName,64,1979,29, this);
	...
	"setValues": function( value ) {
		...
		try { egl.enter("setValues",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,33,1149,15, this);
			this.values = value;
			egl.atLine(this.eze$$fileName,34,1168,17, this);
			this.removeChildren();
			egl.atLine(this.eze$$fileName,35,1189,84, this);
			{
				try{egl.enterBlock();
					var i = 0;
					...
					for ( ; (i <= this.options.getSize()); i = (i + 1) )
					{
						egl.setLocalFunctionVariable("i", i, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,36,1232,34, this);
			...
			egl.atLine(this.eze$$fileName,38,1277,20, this);
			this.options.removeAll();
			egl.atLine(this.eze$$fileName,39,1301,33, this);
			this.setAttribute("multiple", {eze$$value : "true", eze$$signature : "S;"} );
			egl.atLine(this.eze$$fileName,40,1338,201, this);
			{
				try{egl.enterBlock();
					var index = 0;
					...
					for ( ; (index <= value.getSize()); index = (index + 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,41,1415,18, this);
							option.setTagName( "option" );
							egl.atLine(this.eze$$fileName,42,1440,32, this);
							option.setInnerHTML( egl.checkNull(value, "value")[value.checkIndex((index)-1)] );
							egl.atLine(this.eze$$fileName,43,1477,30, this);
							this.options.appendElement( option );
							egl.atLine(this.eze$$fileName,44,1512,20, this);
			...
			egl.atLine(this.eze$$fileName,46,1543,51, this);
			if ( !(this.sizeSet) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,47,1569,16, this);
					var ezert$$4 = 0;
					ezert$$4 = this.values.getSize();
					egl.atLine(this.eze$$fileName,47,1561,26, this);
					this.setSize(ezert$$4 );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,49,1598,108, this);
			if ( ((this.textLayoutThis == "Visual") || (this.reverseTextDirectionThis == "Yes")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,50,1682,17, this);
					this.setBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,32,1108,606, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getValues": function() {
		...
		try { egl.enter("getValues",this,arguments,eze$$updater);
			var $result = null;
			egl.atLine(this.eze$$fileName,55,1763,16, this);
			$result = this.values;
	...
	"setSelection": function( selection ) {
		...
		try { egl.enter("setSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,59,1836,30, this);
			this.savedSelection = (function(){ var ezert$$5= []; ezert$$5.setType( "I;" );for (var i=0; i < 0; i++) {
					ezert$$5[ i ] = 0;
				}
				// no max size set for this array
			return ezert$$5;})();
			egl.atLine(this.eze$$fileName,60,1870,38, this);
			this.savedSelection.appendAll( selection );
			egl.atLine(this.eze$$fileName,61,1912,55, this);
			(function () {
				var ezert$$6 = new egl.egl.javascript.Job();
				egl.atLine(this.eze$$fileName,61,1921,29, this);
			...
			egl.atLine(this.eze$$fileName,58,1791,182, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"selectionSetter": function() {
		...
		try { egl.enter("selectionSetter",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,67,2052,107, this);
			if ( (this.savedSelection != null) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,68,2086,39, this);
					this.setSelectionInternal(this.savedSelection );
					egl.atLine(this.eze$$fileName,69,2130,22, this);
					this.savedSelection = null;
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,66,2014,151, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"setSelectionInternal": function( selection ) {
		...
		try { egl.enter("setSelectionInternal",this,arguments,eze$$updater);
			egl.addLocalFunctionVariable("selection", selection, "int[]", "!selection");
			egl.atLine(this.eze$$fileName,74,2232,152, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.options.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,75,2285,44, this);
							egl.checkNull(this.options, "options")[this.options.checkIndex((index)-1)].setAttribute("selected", "" );
							egl.atLine(this.eze$$fileName,76,2334,43, this);
			...
			egl.atLine(this.eze$$fileName,78,2388,201, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= selection.getSize()); index = (index + 1) )
					{
						...
						try{egl.enterBlock();
							...
							egl.atLine(this.eze$$fileName,79,2447,61, this);
							if ( (egl.checkNull(selection, "selection")[selection.checkIndex((index)-1)] > 0) ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,79,2491,17, this);
									var ezert$$7 = 0;
							...
							egl.atLine(this.eze$$fileName,79,2443,139, this);
							if ( eze_Cond_Temp_0 ) {
								try{egl.enterBlock();
									egl.atLine(this.eze$$fileName,80,2515,59, this);
			...
			egl.atLine(this.eze$$fileName,83,2593,108, this);
			if ( ((this.textLayoutThis == "Visual") || (this.reverseTextDirectionThis == "Yes")) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,84,2677,17, this);
					this.setBiDiMarkers();
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,73,2171,538, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSelection": function() {
		...
		try { egl.enter("getSelection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,90,2778,170, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
			...
			egl.atLine(this.eze$$fileName,95,2952,18, this);
			$result = selected;
	...
	"setSize": function( sizeIn ) {
		...
		try { egl.enter("setSize",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,99,3017,95, this);
			if ( (sizeIn > 1) ) {
				try{egl.enterBlock();
					egl.atLine(this.eze$$fileName,100,3037,14, this);
					this.size = sizeIn;
					egl.atLine(this.eze$$fileName,101,3056,15, this);
					this.sizeSet = true;
					egl.atLine(this.eze$$fileName,102,3076,29, this);
					this.setAttribute("size", {eze$$value : sizeIn, eze$$signature : "I;"} );
				}finally{egl.exitBlock();}
			}
			egl.atLine(this.eze$$fileName,98,2982,136, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getSize": function() {
		...
		try { egl.enter("getSize",this,arguments,eze$$updater);
			var $result = 0;
			egl.atLine(this.eze$$fileName,107,3160,14, this);
			$result = this.size;
			egl.setLocalFunctionVariable("INT", $result, "int");
			{ if (!egl.debugg) egl.leave(); return $result;}
		} finally {
	...
	"setTextLayout": function( textLayout ) {
		...
		try { egl.enter("setTextLayout",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,111,3248,33, this);
			this.textLayoutThis = textLayout;
			egl.atLine(this.eze$$fileName,112,3286,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,110,3186,123, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTextLayout": function() {
		...
		try { egl.enter("getTextLayout",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,116,3374,29, this);
	...
	"setReverseTextDirection": function( reverseTextDirection ) {
		...
		try { egl.enter("setReverseTextDirection",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,120,3496,53, this);
			this.reverseTextDirectionThis = reverseTextDirection;
			egl.atLine(this.eze$$fileName,121,3556,17, this);
			this.setBiDiMarkers();
			egl.atLine(this.eze$$fileName,119,3414,165, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getReverseTextDirection": function() {
		...
		try { egl.enter("getReverseTextDirection",this,arguments,eze$$updater);
			var $result = "";
			egl.atLine(this.eze$$fileName,125,3654,39, this);
	...
	"setBiDiMarkers": function() {
		...
		try { egl.enter("setBiDiMarkers",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,129,3743,51, this);
			...
			egl.atLine(this.eze$$fileName,130,3798,68, this);
			...
			egl.atLine(this.eze$$fileName,131,3872,121, this);
			{
				try{egl.enterBlock();
					var index = 0;
					egl.addLocalFunctionVariable("index", index, "int", "index");
					...
					for ( ; (index <= this.options.getSize()); index = (index + 1) )
					{
						egl.setLocalFunctionVariable("index", index, "int");
						try{egl.enterBlock();
							egl.atLine(this.eze$$fileName,132,3927,59, this);
			...
			egl.atLine(this.eze$$fileName,128,3706,295, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }

...
egl.defineClass('com.ibm.egl.rui.widgets', 'DataGridTooltip', {
	'eze$$fileName': '/com.ibm.egl.rui_4.3.7/EGLSource/com/ibm/egl/rui/widgets/DataGridTooltip.egl',
	...
	"constructor" : function()
	{
		...
		try { egl.enter("<init>",this,arguments,eze$$updater);
			egl.atLine(this.eze$$fileName,17,449,37, this);
			this.provider = null;
			
			egl.atLine(this.eze$$fileName,18,489,14, this);
			this.grid = null;
			egl.addEmbeddedWidget(this, "grid");
			
			egl.atLine(this.eze$$fileName,20,509,58, this);
			this.tooltip = new egl.com.ibm.egl.rui.widgets.Tooltip();
			egl.addEmbeddedWidget(this, "tooltip");
			
			this.jsrt$SysVar= new egl.egl.core.SysVar();
			egl.atLine(this.eze$$fileName,20,535,29, this);
			egl.checkNull(this.tooltip, "tooltip").provider = new egl.egl.jsrt.Delegate(this, egl.com.ibm.egl.rui.widgets.DataGridTooltip.prototype.getTooltipContents,"getTooltipContents");
	...
	"setTooltips": function( grid, td, row, dataIndex, column ) {
		...
		try { egl.enter("setTooltips",this,arguments,eze$$updater);
			...
			egl.atLine(this.eze$$fileName,23,685,43, this);
			td.setAttribute("enablePropagation", true );
			egl.atLine(this.eze$$fileName,24,732,19, this);
			egl.checkNull(this.tooltip, "tooltip").enable(td );
			egl.atLine(this.eze$$fileName,25,755,17, this);
			this.grid = grid;
			egl.atLine(this.eze$$fileName,22,573,205, this);
			{ if (!egl.debugg) egl.leave(); }
		} finally {
			if (!egl.debugg){
			} else { egl.leave(); }
	...
	"getTooltipContents": function( widget ) {
		...
		try { egl.enter("getTooltipContents",this,arguments,eze$$updater);
			...
			var td = null;
			egl.addLocalFunctionVariable("td", td, "egl.ui.rui.Widget", "td");
			egl.atLine(this.eze$$fileName,29,843,19, this);
			...
			var row = null;
			egl.addLocalFunctionVariable("row", row, "any", "row");
			egl.atLine(this.eze$$fileName,30,886,22, this);
			var ezert$$1 = null;
			ezert$$1 = td.getAttribute("row" );
			egl.atLine(this.eze$$fileName,30,866,44, this);
			...
			var column = null;
			egl.addLocalFunctionVariable("column", column, "com.ibm.egl.rui.widgets.DataGridColumn", "column");
			egl.atLine(this.eze$$fileName,31,938,18, this);
			var ezert$$2 = null;
			ezert$$2 = egl.checkNull(this.grid, "grid").getColumn(td );
			egl.atLine(this.eze$$fileName,31,914,43, this);
			column = ezert$$2;
			egl.setLocalFunctionVariable("column", column, "com.ibm.egl.rui.widgets.DataGridColumn");
			var tip = null;
			egl.addLocalFunctionVariable("tip", tip, "com.ibm.egl.rui.widgets.Box", "tip");
			egl.atLine(this.eze$$fileName,32,971,30, this);
			var ezert$$3 = null;
			ezert$$3 = this.provider(row, egl.checkNull(column, "column").name, td );
			egl.atLine(this.eze$$fileName,32,961,41, this);
			tip = ezert$$3;
			egl.setLocalFunctionVariable("tip", tip, "com.ibm.egl.rui.widgets.Box");
			egl.atLine(this.eze$$fileName,33,1006,12, this);
			$result = tip;
	...
	"eze$$getChildVariables": function() {
		...
		{name: "provider", value : eze$$parent.provider, type : "com.ibm.egl.rui.widgets.DataGridTooltipTextProvider", jsName : "provider"},
